<%@ Page Title="" Language="C#" MasterPageFile="~/DefaultHome.master" AutoEventWireup="true" CodeFile="DoctorCashCollectedReport.aspx.cs" Inherits="Design_CommonReports_DoctorCashCollectedReport" %>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" ID="Conetent1" runat="server">
    ...
    <div id="Pbody_box_inventory">
        <div class="POuter_Box_Inventory" style="text-align: center;">
            ...
            <b>Cash Doctor Collection Report</b>
            <br />
            ...
            <div class="row">
                ...
                <div class="col-md-22">
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <asp:DropDownList ID="ddlDoctor" class="requiredField" runat="server" TabIndex="1" ClientIDMode="Static">
                            </asp:DropDownList>
                        </div>
                        <div class="col-md-3">
                            <label class="pull-left">
                        ...
                        <div class="col-md-5">
                            <asp:TextBox ID="txtFromDate" runat="server" ClientIDMode="Static" TabIndex="2"></asp:TextBox>
                        ...
                        <div class="col-md-5">
                            <asp:TextBox ID="txtToDate" runat="server" ClientIDMode="Static" ToolTip="Select To Date" TabIndex="3"></asp:TextBox>
