    ...
    <div id="Pbody_box_inventory">
        ...
        <div class="row">
                        ...
                        <div class="col-md-11">
                            ...
                            <button type="button" style="width:25px;display:none; height:25px;margin-left:5px;float:left;background-color:yellowgreen;cursor: default;" class="circle"></button>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                $Search = function () {
                    if ($('#txtPatientID').val() == "") {
                        modelAlert('Please Enter Folder No.');
                        $('#txtPatientID').focus();
                        return false;
                    }
                ...
                $bindPatientDetails = function () {
                    ...
                    $('#spnPanel').text(Data[0].Company_Name);
		...
		<table class="FixedTables" cellspacing="0" rules="all" border="1" id="tb_PtHistory" style="width:100%;border-collapse:collapse;">
			...
			<tr
			 ...
			 > 
				...
				<td class="GridViewLabItemStyle" id="tdTnxId" style="display:none;"><#=objRow.Transaction_ID#></td>
