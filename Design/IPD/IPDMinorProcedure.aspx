<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IPDMinorProcedure.aspx.cs" Inherits="Design_IPD_IPDMinorProcedure" %>
...
<body>
    ...
    <script type="text/javascript">
        ...
        function AddItem() {
            ...
            alreadyPrescribeItem({ PatientID: $.trim($('#spnPatientID').text()), ItemID: ItemID }, function (response) {
                if (response) {
                    ...
                    Rate = Number($("#cmbItem").combogrid('getValue').split('#')[1].trim()).toFixed(4);
                    $.ajax({
                    ...
                    for (var i = 0; i <= Days ; i++) {
                        $('#tbSelected').append('<tr><td class="GridViewLabItemStyle" style="width:70px" ><span id="ItemCode">' + ItemCode +
                                                ...
                                                ' </input></td><td class="GridViewLabItemStyle" style="width:40px"><input id="txtDiscountPer" onlynumber="14" decimalplace="4" max-value="100" onkeyup="onDiscountPercentChange(this)" onkeypress="$commonJsNumberValidation(event)" onkeydown="$commonJsPreventDotRemove(event)"  class="ItDoseTextinputNum" type="text" autocomplete="off" style="width:100px" class="ItDoseTextinputNum" ' + IsDiscount + ' value=' + Disc +
        ...
        function Rate(rowid) {
            ...
            if ($(rowid).closest('tr').find("#spnQuantity").val() == "0") {
                $(rowid).closest('tr').find("#spnQuantity").val('1');
            }
        ...
        function bindRate() {
            ...
            $('#tbSelected tr').each(function () {
                ...
                if (id != "ItemHeader") {
                    var Grossamount = Number(Number($(this).closest('tr').find("#txtRate").val()) * Number($(this).closest('tr').find("#spnQuantity").val()));
                    var DiscountAmount = Number(((Number(Grossamount) * Number($(this).closest('tr').find("#txtDiscountPer").val()) / 100)));
                    ...
                    $('#spnTotalNetAmount').text(precise_round(totalNAmount, 4));
                    $('#spnTotalRoundOff').text(precise_round(Math.round(totalNAmount) - totalNAmount, 4))
                    if (totalGAmount >= 0) {
                        $('#divTotalAmt').show();
                        $('#divSave').show();
                    }
        ...
        var onDiscountPercentChange = function (el) {
            var discountPrecent = Number(el.value);
            var amount = Number($(el).closest('tr').find('#txtRate').val());
            var discountAmount = ((amount * discountPrecent) / 100);
            $(el).closest('tr').find('#txtAmount').val(amount - discountAmount);
            bindRate();
        }
                ...
                <div class="row">
                    <div class="col-md-24">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <select id="ddlCategory" onchange="LoadSubCategory();" tabindex="111"></select>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-8">
                                <select id="ddlSubCategory" tabindex="112"></select>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-2">
                             ...
                             <div class="col-md-2">
                                 <select id="ddlSearchBy" onchange="onSearchTypeChange(this)">
                            ...
                            <div class="col-md-8">
                                <input id="cmbItem" tabindex="1" class="easyui-combogrid" style="width: 250px; height: 20px" data-options="
			panelWidth: 600,
			idField: 'ItemId',
			textField: 'TypeName',
            mode:'remote',                                       
			url: 'IPDMinorProcedure.aspx?cmd=item',
            loadMsg: 'Serching... ',
			method: 'get',
            pagination:true,
            rownumbers:true,
		...
		" />
                            ...
                            <div class="col-md-4">
                                <input type="text" id="txtQuantity" class="requiredField" placeholder="Enter Quantity" autocomplete="off"
                                    onkeypress="return checkNumericDecimal(event,this);" tabindex="2" value="1" />
                            </div>
                        ...
                        <div class="row showprescription">
                            ...
                            <div class="col-md-4 showprescription">
                                <label class="pull-left">Repeat Freq.</label>
                                <b class="pull-right">:</b>
                            </div>
                            <div class="col-md-4 showprescription">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <input type="text" id="txtRemarks" class="ItDoseTextinputText" tabindex="5" onkeypress="AddInvestigation(this,event);" />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4"></div>
                            <div class="col-md-4">
                                <input type="button" id="btnAdd" title="Add Item" value="Add Item" tabindex="7" class="ItDoseButton" onclick="AddItem();" />
                            </div>
                        </div>
                    </div>
                </div>
...
<tbody></tbody>                            
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <label class="pull-left">
                                    <span id="spnTotalAmountText" class="lblDetails">Gross Amount</span>
                                </label>
                                <b class="pull-right">:</b>
                            </div>
                            <div class="col-md-2">
                                <label class="pull-left">
                                    <span id="spnGrossAmount" class="lblDetails"></span>
                                </label>
                            </div>
                            <div class="col-md-5">
                                <label class="pull-left">
                                    <span id="spntotaldiscount" class="lblDetails">Discount Amount</span></label>
                                <b class="pull-right lblDetails">:</b>
                            </div>
                            <div class="col-md-2">
                                <label class="pull-left">
                                    <span id="spnTotalDiscountAmount" class="lblDetails"></span>
                                </label>
                            </div>
                            <div class="col-md-4">
                                <label class="pull-left">
                                    <span id="spnNetAmount" class="lblDetails">Net Amount</span></label>
                                <b class="pull-right lblDetails">:</b>
                            </div>
                            <div class="col-md-2">
                                <label class="pull-left">
                                    <span id="spnTotalNetAmount" class="lblDetails"></span>
                                </label>
                            </div>
                            <div class="col-md-3">
                                <label class="pull-left lblDetails"></label>
                                <b class="pull-right lblDetails"></b>
                            </div>
                            <div class="col-md-2">
                                <label class="pull-left">
                                    <span id="spnTotalRoundOff" class="lblDetails" style="display: none;"></span>
                                </label>
                            </div>
                        </div>
                    </div>
        ...
        <script type="text/javascript">
            ...
            var onSearchTypeChange = function (elem) {
                try {
                    var options = $('#cmbItem').combogrid('options');
            ...
            function LedgerTransaction() {
                ...
                objLT.GrossAmount = Number($.trim($('#spnGrossAmount').text()));
                objLT.DiscountOnTotal = Number($.trim($('#spnTotalDiscountAmount').text()));
                objLT.NetAmount = Number($.trim($('#spnTotalNetAmount').text()));
                objLT.PatientID = $('#spnPatientID').text();
                objLT.RoundOff = Number($('#spnTotalRoundOff').text());
            ...
            function LedgerTransactionDetail() {
                ...
                $("#tbSelected tr").each(function () {
                    ...
                    if (id != "ItemHeader") {
                        ...
                        objLTD.Rate = Number($.trim($rowid.find("#txtRate").val()));
                        objLTD.Quantity = Number($.trim($rowid.find("#spnQuantity").val()));
                        objLTD.Amount = Number($.trim($rowid.find("#txtAmount").val()));
                        objLTD.DiscountPercentage = Number($.trim($rowid.find("#txtDiscountPer").val()));
                        objLTD.DiscAmt = Number($.trim($rowid.find("#txtRate").val()) * Number($.trim($rowid.find("#spnQuantity").val()))) * Number($.trim($rowid.find("#txtDiscountPer").val()) / 100);
                        objLTD.IsVerified = 1;
                        ...
                        objLTD.NetItemAmt = Number($('#spnGrossAmount').text());
                        ...
                        objLTD.CoPayPercent = Number($.trim($rowid.find('#spncopayment').text()));
                        ...
                        objLTD.IGSTPercent = Number($.trim($rowid.find('#spnGSTDetails').text().split('^')[1]));
                        objLTD.CGSTPercent = Number($.trim($rowid.find('#spnGSTDetails').text().split('^')[3]));
                        objLTD.SGSTPercent = Number($.trim($rowid.find('#spnGSTDetails').text().split('^')[2]));
            ...
            function Validation() {
                ...
                $("#tbSelected tr").each(function () {
                    ...
                    var $rowid = $(this).closest("tr");
                    if (id != "ItemHeader") {
                       if ($.trim(Number($rowid.find("#txtRate").val())) == 0 || $.trim($rowid.find("#txtRate").val()) == '') {
                            zerorateiten += 1;
                        }
                    }
                });
                ...
                if (data.PatientID.trim() != '') {
                    serverCall('Services/IPDLabPrescription.asmx/getAlreadyPrescribeItem', data, function (response) {
                        ...
                        if (responseData != null && responseData != "") {
                            modelConfirmation('Do You Want To Prescribe Again  ?', 'This Procedure is Already Prescribed By ' + responseData[0].UserName + '</br> Date On ' + responseData[0].EntryDate, 'Prescribe Again', 'Cancel', function (response) {
                                if (response)
                                    callBack(response);
                            });
                        }
