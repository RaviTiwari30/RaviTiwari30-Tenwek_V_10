<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IPD_FinalDiagnosis.aspx.cs" Inherits="Design_IPD_IPD_FinalDiagnosis" %>
    ...
    <form id="form1" runat="server">
        <div>
            <div id="Pbody_box_inventory" style="text-align: center">
                <div class="POuter_Box_Inventory" style="width:100%; display:none">
                    <div class="HeaderTab" style="width:100%;">
                        <ul style="background-color: transparent; border-color: Transparent; border-width: 1px; border-style: None; width: 100%; border-collapse: collapse;">
                            <li style="width:20%;background-color:lightblue;border: solid 1px transparent">
                                <asp:LinkButton ID="lbProvisional" runat="server" OnClick="lbProvisional_Click"  ForeColor="White">Provisional Diagnosis</asp:LinkButton>
                            </li>
                            <li style="width:3%;background-color:white">

                            </li>
                            <li style="width:20%;background-color:lightblue;border: solid 1px transparent">
                                <asp:LinkButton ID="lbFinalDiagnosis" runat="server" OnClick="lbFinalDiagnosis_Click"  ForeColor="White">Final Diagnosis</asp:LinkButton>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-24">
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                     <asp:TextBox ID="txtCode" runat="server" autocomplete="off" TabIndex="6"></asp:TextBox>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                     <asp:TextBox ID="txtComments" runat="server" ToolTipl="Enter Comments" TabIndex="7"></asp:TextBox>
                                </div>
                                    ...
                                    <asp:GridView ID="grvCode" runat="server" AutoGenerateColumns="False" CssClass="GridViewStyle"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="WHO_Full_Desc" HeaderText="ICD Desc.">
                                              ...
                                              <asp:BoundField DataField="Remarks" HeaderText="Comment">
                                                <ItemStyle CssClass="GridViewItemStyle" />
                    ...
                    <table style="width: 680px; border-collapse: collapse">
                        ...
                        <tr>
                            ...
                            <td style="width: 225px; text-align: left;">
                                <asp:TextBox ID="txtSectionId" TabIndex="1" Width="95%" CssClass="requiredField" ToolTip="Enter Section Code" MaxLength="20"
                            ...
                            <td style="width: 225px; text-align: left;">
                                <asp:TextBox ID="txtSection" TabIndex="2" Width="95%" CssClass="requiredField" ToolTip="Enter Section Desc." MaxLength="250"
                                    runat="server"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td style="width: 225px; text-align: left;">
                                <asp:TextBox ID="txtSubSection" TabIndex="4" Width="95%" CssClass="requiredField" ToolTip="Enter Sub Section Desc." MaxLength="250"
                                    runat="server"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td style="width: 225px; text-align: left;">
                                <asp:TextBox ID="txtDiagnosisCode" TabIndex="5" Width="95%" CssClass="requiredField" ToolTip="Enter ICD Code" MaxLength="200"
                                    runat="server"></asp:TextBox>
                            ...
                            <td style="width: 225px; text-align: left;">
                                <asp:TextBox ID="txtDiagnosisDesc" TabIndex="6" Width="95%" CssClass="requiredField" ToolTip="Enter ICD Desc." MaxLength="20"
                                    runat="server"></asp:TextBox>
