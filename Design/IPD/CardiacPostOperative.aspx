<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CardiacPostOperative.aspx.cs" Inherits="Design_IPD_CardiacPostOperative" %>
   ...
   <%-- <link rel="stylesheet" type="text/css" href="../../Styles/easyui.css" />--%>
    <script type="text/javascript">
        ...
        function search() {
            ...
            jQuery.ajax({
                type: "POST",
                url: "CardiacPostOperative.aspx/BindSearch",
                data: '{key:"' + key + '"}',
                dataType: "json",
    ...
    <form id="form2" runat="server">
        ...
        <div class="POuter_Box_Inventory" style="text-align: center;">
             <div class="Purchaseheader" style="text-align: center">
                  <b>Tenwek Hospital Cardiac PostOperative EchoCardiogram Report</b>
                </div>
                        ...
                        <tr>
                            ...
                            <td class="GridViewLabItemStyle"   colspan="3"    >
                                <table style="width:100%;" border="1">
                                    <tr><th></th><th>VC</th><th>PHT</th><th>VTI</th><th>GRADE</th><th>PG</th><th>PMAX</th><th>PMean</th><th>V Type</th><th>V Size</th><th>ANNULA SIze</th></tr>
                                <tr>
                                    <td>AV</td>
                                    <td>
                                        <asp:TextBox ID="txtAV1" CssClass="" runat="server"      ClientIDMode="Static" ></asp:TextBox>
                                     
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtAV2" CssClass="" runat="server"      ClientIDMode="Static" ></asp:TextBox>
                                     
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtAV3" CssClass="" runat="server"      ClientIDMode="Static" ></asp:TextBox>
                                     
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtAV4" CssClass="" runat="server"      ClientIDMode="Static" ></asp:TextBox>
                                     
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtAV5" CssClass="" runat="server"      ClientIDMode="Static" ></asp:TextBox>
                                     
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtAV6" CssClass="" runat="server"      ClientIDMode="Static" ></asp:TextBox>
                                     
                                    </td>
                                    
                                    <td>
                                        <asp:TextBox ID="txtAV7" CssClass="" runat="server"      ClientIDMode="Static" ></asp:TextBox>
                                     
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtAV8" CssClass="" runat="server"      ClientIDMode="Static" ></asp:TextBox>
                                     
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtAV9" CssClass="" runat="server"      ClientIDMode="Static" ></asp:TextBox>
                                     
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtAV10" CssClass="" runat="server"      ClientIDMode="Static" ></asp:TextBox>
                                  ...
                                  <tr>
                                    <td>MV</td>
                                    <td>
                                        <asp:TextBox ID="txtMV1" CssClass="" runat="server"      ClientIDMode="Static" ></asp:TextBox>
                                     
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtMV2" CssClass="" runat="server"      ClientIDMode="Static" ></asp:TextBox>
                                     
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtMV3" CssClass="" runat="server"      ClientIDMode="Static" ></asp:TextBox>
                                     
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtMV4" CssClass="" runat="server"      ClientIDMode="Static" ></asp:TextBox>
                                     
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtMV5" CssClass="" runat="server"      ClientIDMode="Static" ></asp:TextBox>
                                     
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtMV6" CssClass="" runat="server"      ClientIDMode="Static" ></asp:TextBox>
                                     
                                    </td>
                                    
                                    <td>
                                        <asp:TextBox ID="txtMV7" CssClass="" runat="server"      ClientIDMode="Static" ></asp:TextBox>
                                     
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtMV8" CssClass="" runat="server"      ClientIDMode="Static" ></asp:TextBox>
                                     
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtMV9" CssClass="" runat="server"      ClientIDMode="Static" ></asp:TextBox>
                                     
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtMV10" CssClass="" runat="server"      ClientIDMode="Static" ></asp:TextBox>
                                    ...
                                    <td>PV</td>
                                    <td>
                                        <asp:TextBox ID="txtPV1" CssClass="" runat="server"      ClientIDMode="Static" ></asp:TextBox>
                                     
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtPV2" CssClass="" runat="server"      ClientIDMode="Static" ></asp:TextBox>
                                     
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtPV3" CssClass="" runat="server"      ClientIDMode="Static" ></asp:TextBox>
                                     
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtPV4" CssClass="" runat="server"      ClientIDMode="Static" ></asp:TextBox>
                                     
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtPV5" CssClass="" runat="server"      ClientIDMode="Static" ></asp:TextBox>
                                     
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtPV6" CssClass="" runat="server"      ClientIDMode="Static" ></asp:TextBox>
                                     
                                    </td>
                                    
                                    <td>
                                        <asp:TextBox ID="txtPV7" CssClass="" runat="server"      ClientIDMode="Static" ></asp:TextBox>
                                     
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtPV8" CssClass="" runat="server"      ClientIDMode="Static" ></asp:TextBox>
                                     
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtPV9" CssClass="" runat="server"      ClientIDMode="Static" ></asp:TextBox>
                                     
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtPV10" CssClass="" runat="server"      ClientIDMode="Static" ></asp:TextBox>
                                    ...
                                    <td>TV</td>
                                    <td>
                                        <asp:TextBox ID="txtTV1" CssClass="" runat="server"      ClientIDMode="Static" ></asp:TextBox>
                                     
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtTV2" CssClass="" runat="server"      ClientIDMode="Static" ></asp:TextBox>
                                     
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtTV3" CssClass="" runat="server"      ClientIDMode="Static" ></asp:TextBox>
                                     
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtTV4" CssClass="" runat="server"      ClientIDMode="Static" ></asp:TextBox>
                                     
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtTV5" CssClass="" runat="server"      ClientIDMode="Static" ></asp:TextBox>
                                     
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtTV6" CssClass="" runat="server"      ClientIDMode="Static" ></asp:TextBox>
                                     
                                    </td>
                                    
                                    <td>
                                        <asp:TextBox ID="txtTV7" CssClass="" runat="server"      ClientIDMode="Static" ></asp:TextBox>
                                     
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtTV8" CssClass="" runat="server"      ClientIDMode="Static" ></asp:TextBox>
                                     
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtTV9" CssClass="" runat="server"      ClientIDMode="Static" ></asp:TextBox>
                                     
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtTV10" CssClass="" runat="server"      ClientIDMode="Static" ></asp:TextBox>
                            ...
                            <td class="GridViewLabItemStyle"   colspan="1"    >Tapse</td>
                                      
                            <td class="GridViewLabItemStyle"   colspan="2"    ><asp:TextBox ID="txtImpression" CssClass="" runat="server"    ClientIDMode="Static" ></asp:TextBox>
                                     </td>
                                      </tr>
                                  <tr>
