<%@ Page Title="" Language="C#" MasterPageFile="~/DefaultHome.master" AutoEventWireup="true" CodeFile="CatherPatientReport.aspx.cs" Inherits="Design_IPD_CatherPatientReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <script type="text/javascript" >
        ...
        function bindVentilator() {
            ...
            if ($('#chkInfected').is(':checked'))
                var isinfected = 1;
            $.ajax({
                url: "CatherPatientReport.aspx/Cather",
    ...
    style="width:960px;border-collapse:collapse; text-align:center">
		<tr id="Tr1">
            ...
            <th class="GridViewHeaderStyle" scope="col" style="width:100px;">Particular</th>
            <th class="GridViewHeaderStyle" scope="col" style="width:100px;">CBG</th>
            <th class="GridViewHeaderStyle" scope="col" style="width:100px;">Correction</th>
