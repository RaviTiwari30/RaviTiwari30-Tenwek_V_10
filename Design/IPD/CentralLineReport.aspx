<%@ Page Title="" Language="C#" MasterPageFile="~/DefaultHome.master" AutoEventWireup="true" CodeFile="CentralLineReport.aspx.cs" Inherits="Design_IPD_CentralLineReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <script type="text/javascript" >
        ...
        function bindVentilator() {
            ...
            if ($('#chkInfected').is(':checked'))
                var isinfected = 1;
            $.ajax({
                url: "CentralLineReport.aspx/Cather",
        ...
        function View(rowid) {
            $('#spninfection').text($.trim($(rowid).closest('tr').find("#td12").text()));
            $('#spninfectionUser').text($.trim($(rowid).closest('tr').find("#td13").text()));
    ...
    <div id="Pbody_box_inventory">
        <div class="POuter_Box_Inventory" style="text-align: center;">
                ...
                <b>Patient Central Line Bundle Report</b>
                <br />
    ...
    style="width:960px;border-collapse:collapse; text-align:center">
		<tr id="Tr1">
            ...
            <th class="GridViewHeaderStyle" scope="col" style="width:80px;">Date/Time of Insertion</th>
            <th class="GridViewHeaderStyle" scope="col" style="width:80px;">Date/Time of Removal</th>
            <th class="GridViewHeaderStyle" scope="col" style="width:100px;">No. of Days</th>
            <th class="GridViewHeaderStyle" scope="col" style="width:100px;">Inserted By</th>
            <th class="GridViewHeaderStyle" scope="col" style="width:100px;">Removed By</th>
        ...
        #>
                    ...
                    <td class="GridViewLabItemStyle" id="td6"  style="width:80px;text-align:center" ><#=objRow.DateofInsertion#></td>
                    <td class="GridViewLabItemStyle" id="td7"  style="width:80px;text-align:center" ><#=objRow.DateofRemoval#></td>
                    <td class="GridViewLabItemStyle" id="td9"  style="width:100px;text-align:center" ><#=objRow.Days#></td>
                    <td class="GridViewLabItemStyle" id="td8"  style="width:100px;text-align:center" ><#=objRow.InsertedBy#></td>
                    <td class="GridViewLabItemStyle" id="td10"  style="width:100px;text-align:center" ><#=objRow.RemovedBy#></td>
                        <td class="GridViewLabItemStyle" id="td12"  style="width:100px;text-align:center;display:none" ><#=objRow.Infection#></td>
                        <td class="GridViewLabItemStyle" id="td13"  style="width:100px;text-align:center;display:none" ><#=objRow.InfectionUser#></td>
