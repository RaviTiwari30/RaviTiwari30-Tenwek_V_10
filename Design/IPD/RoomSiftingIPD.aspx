<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RoomSiftingIPD.aspx.cs" Inherits="Design_IPD_RoomBilling" %>
    ...
    <form id="form1" runat="server">
        ...
        <div id="Pbody_box_inventory">
            ...
            <asp:Panel ID="pnlPatient" runat="server">
                <div class="POuter_Box_Inventory">
                    ...
                    <table style="width: 100%; border-collapse: collapse">
                        <tr>
                            <td style="width: 15%; text-align: right">Room Type :&nbsp;
                            </td>
                            <td style="width: 35%; text-align: left">
                                <asp:Label ID="lblCurRoomCat" runat="server" CssClass="ItDoseLabelSp" />
                            </td>
                            <td style="width: 20%; text-align: right">Billing Type :&nbsp;
                            </td>
                        ...
                        <tr>
                            <td style="width: 15%; text-align: right">Room :&nbsp;
                            </td>
                            <td style="width: 35%; text-align: left">
                                <asp:Label ID="lblCurRoom" runat="server" CssClass="ItDoseLabelSp" />
                            </td>
                            <td style="width: 20%; text-align: right">Admitted/Shifted On :&nbsp;
                            </td>
                            <td style="width: 30%; text-align: left">
                ...
                <div class="POuter_Box_Inventory">
                    ...
                    <table style="width: 100%; border-collapse: collapse">
                        <tr>
                            ...
                            <td style="width: 15%; text-align: right">Billing Type :&nbsp;
                            </td>
                            <td style="width: 35%; text-align: left">
                        ...
                        <tr>
                            <td style="width: 15%; text-align: right">Available Room :&nbsp;
                            </td>
                            <td style="width: 35%; text-align: left">
                            ...
                            <td style="width: 15%; text-align: right">Shift Date Time :&nbsp;
                            </td>
                            <td style="width: 35%; text-align: left">
                        ...
                        <tr style="<%=Resources.Resource.RoomShifitingRequest=="1" ? "": "display:none" %>">
                            <td style="width: 15%; text-align: right">Requisition Status :&nbsp;
                            </td>
                            <td style="width: 35%; text-align: left">
                ...
                <div class="POuter_Box_Inventory" style="text-align: center; <%=Resources.Resource.RoomShifitingRequest=="1" ? "": "display:none" %>">
                    <div class="Purchaseheader">
                        Requisition Details
                    </div>
            ...
            <asp:Button ID="btnClose" runat="server" Text="Cancel" CausesValidation="false"
                ...
                <asp:Label ID="lblIPDNo" runat="server" Visible="false"></asp:Label>
