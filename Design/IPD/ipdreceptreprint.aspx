<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IPDReceptReprint.aspx.cs" Inherits="Design_IPD_IPDReceptReprint" MasterPageFile="~/DefaultHome.master" %>
            ...
            <div class="POuter_Box_Inventory">
                ...
                <div style="overflow: auto; padding: 3px; height: 340px;">
                    <asp:GridView ID="GridView1" Width="100%" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" ShowFooter="true"
                        ...
                        <Columns>
                            <asp:BoundField DataField="depositor" HeaderText="UHID">
                            ...
                            <asp:BoundField DataField="AmountPaid" HeaderText="Receipt Amount">
