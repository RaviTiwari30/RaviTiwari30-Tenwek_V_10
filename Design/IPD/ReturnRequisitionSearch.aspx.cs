...
public partial class Design_IPD_ReturnRequisitionSearch : System.Web.UI.Page
{
    ...
    private void BindDetails()
    {
        ...
        sb.Append("   id.IndentType FROM f_indent_detail_patient_return id INNER JOIN patient_medical_history pmh ON pmh.TransactionID = id.TransactionID");
    ...
    protected void grdRequsition_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "AView")
        {
            ...
            sb.Append("     REPLACE(pmh.TransactionID,'ISHHI','')    TransactionID,id.IndentType FROM f_indent_detail_patient_return id ");
        ...
        if (e.CommandName == "APrint")
        {
            ...
            sb1.Append("id.ApprovedBy,id.ApprovedReason,id.dtEntry,id.UserId,Concat(em.Title,' ',em.Name)EmpName,CONCAT(pm.Title,' ',pm.PName)PatientName,Replace(pmh.TransactionID,'ISHHI','')TransactionID,id.IndentType from f_indent_detail_patient_return id inner  ");
            ...
            //ds.WriteXmlSchema(@"c:/PatientReturnIndent.xml");
            Session["ds"] = ds;
            Session["ReportName"] = "PatientReturnIndent";
            lblMsg.Text = "";
