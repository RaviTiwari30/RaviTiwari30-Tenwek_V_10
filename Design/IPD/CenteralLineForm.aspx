<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CenteralLineForm.aspx.cs" Inherits="Design_IPD_CenteralLineForm" %>
                ...
                <table style="width: 100%" id="tb_Record" runat="server" visible="false">
                    <tr>
                        ...
                        <td style="text-align: left">
                            <asp:Label ID="lblcentID" runat="server" Visible="false"></asp:Label>
