...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div id="Pbody_box_inventory">
            ...
            <div class="POuter_Box_Inventory">
                <div class="content">
                    <table cellpadding="0" cellspacing="0">
                        <tr>
                            <td align="right" style="font-size: 10pt; width: 20%">Category :&nbsp;
                            </td>
                            ...
                            <td align="left" style="width: 20%; font-size: 10pt;">
                                <asp:Button ID="btnStock" runat="server" CssClass="ItDoseButton" Width="122px" Text="Check Blood Stock" OnClick="btnStock_Click"  /></td>
                            <td align="left" style="width: 60%; font-size: 10pt;">Blood Group :&nbsp;
                        ...
                        <tr>
                            <td align="right" style="font-size: 10pt; width: 25%">Search By Name:&nbsp;
                            </td>
                        ...
                        <tr style="font-size: 10pt">
                            ...
                            <td align="left" colspan="3">
                                <asp:DropDownList ID="cmbRefferedBy" runat="server" Width="215px" ToolTip="Select Doctor" TabIndex="4" ClientIDMode="Static" />
            ...
            <div class="POuter_Box_Inventory">
                <div class="content" style="text-align: center;">
                    <asp:Button ID="btnSelect" runat="server" CssClass="ItDoseButton" Text="Select" OnClick="btnSelect_Click" TabIndex="8" ToolTip="Click To Add Item" />
                </div>
            </div>
