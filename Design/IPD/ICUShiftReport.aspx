<%@ Page Title="" Language="C#" MasterPageFile="~/DefaultHome.master" AutoEventWireup="true" CodeFile="ICUShiftReport.aspx.cs" Inherits="Design_IPD_ICUShiftReport" %>
        ...
        <div id="Pbody_box_inventory">
            ...
            <div class="POuter_Box_Inventory">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4"> 
                        <asp:TextBox ID="txtIPDNo" runat="server"   ClientIDMode="Static"   ToolTip="IPD No" ></asp:TextBox>
            ...
            <div class="POuter_Box_Inventory" style="text-align: center">
                ...
                <asp:GridView ID="grdPhysical" runat="server" Width="100%" AutoGenerateColumns="False" CssClass="GridViewStyle" OnRowCommand="grdPhysical_RowCommand" OnRowDataBound="grdPhysical_RowDataBound" TabIndex="6">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="IPDNo">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Entry By">
                            <ItemTemplate>
                                <asp:Label ID="lblEntryBy" runat="server" Text='<%#Eval("CreatedBy1") %>'></asp:Label>
                            </ItemTemplate>
                            <ItemStyle CssClass="GridViewItemStyle" />
                            <HeaderStyle CssClass="GridViewHeaderStyle"   />
                        </asp:TemplateField>
