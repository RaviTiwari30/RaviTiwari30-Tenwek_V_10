<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EmergencyPanelAmountAllocation.aspx.cs" Inherits="Design_Emergency_EmergencyPanelAmountAllocation" %>
...
<body>
    ...
    <script type="text/javascript">
        ...
        var getPanelAmountAllocationDetails = function (callback) {
            ...
            var LedgerTransactionNo = Number($.trim($('#lblLedgerTransactionNo').text()));
        ...
        var savePanelAmountAllocationDetails = function (btnSave) {
            ...
            getPanelAmountAllocationDetails(function (data) {
                ...
                serverCall('EmergencyPanelAmountAllocation.aspx/SavePanelAmountAllocationDetails', { panelAllocationDetails: data, totalNetBillAmount: totalNetBillAmount }, function (response) {
        ...
        var getPatientPanelAmountAllocationDetails = function (callback) {
            ...
            serverCall('EmergencyPanelAmountAllocation.aspx/GetPatientPanelAmountAllocationDetails', data, function (response) {
                        ...
                        <table cellspacing="0" style="width: 100%; border-collapse: collapse;">
                            <thead>
                                <tr>
                                    ...
                                    <th class="GridViewHeaderStyle" style="width: 36px">Entry By</th>
