<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EMG_BillingDetails.aspx.cs" Inherits="Design_Emergency_EMG_BillingDetails" %>
        ...
        <div id="Pbody_box_inventory">
                ...
                <div class="row">
                    <div class="col-md-24">
                        ...
                        <div class="row BillInfo">
                            ...
                            <div class="col-md-4">
                                <span id="spanAdvance" style="color: #d01515; font-weight: bold;">0</span>
                            </div>
                        </div>
                        <div class="row">
                              <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <asp:Label ID="lblDischargeStatus" runat="server"  style="color: #d01515; font-weight: bold;" ClientIDMode="Static"></asp:Label>
                            </div>
                        </div>
                    </div>
            ...
            <div class="POuter_Box_Inventory" id="showItemDetails" style="display:none;">
                ...
                <div class="row" style="text-align:center;">
                    ...
                    <input type="button" id="btnUpdateBilling" value="Update Billing" style="width:100px;margin-top:7px;"  onclick="$UpdateBillDetails(this)" />&nbsp;
                    <input type="button" id="btnRelease" value="Release from Emergency" style="width:150px;margin-top:7px;" onclick="$ReleasePatient(this,0)" />&nbsp;
                    <input type="button" id="btnCloseBilling" value="Close Billing" style="width:100px;margin-top:7px;" onclick="$CloseBilling(this)" />
 ...
 <div id="divRejectItem"   class="modal fade ">
	...
	<table  id="tableitemdetails" cellspacing="0" class="GridViewStyle" style="width:100%;border-collapse:collapse;">
		...
		<tr class="tblTitle" id="Header">
			...
			<th class="GridViewHeaderStyle" scope="col" >Rate<br />
			...
			<th class="GridViewHeaderStyle" scope="col" >Disc(%)<br />
		...
		<tr id="<#=objRow.ID#>">
            ...
            <td class="GridViewLabItemStyle">
                 <input type="checkbox" id="cbCheckItem" onclick="$openRowElemenst(this)" class="EditElement" /> 
						...
						<td class="GridViewLabItemStyle"><input type="text" id="txtRate" class="BillInfo" value="<#=objRow.Rate#>" onlynumber="10" decimalplace="2" style="width:80px;" onkeypress="$commonJsNumberValidation(event)" onkeydown="$commonJsPreventDotRemove(event)" onkeyup="$updateRowAmount(this,0)" disabled /></td>    
                        <td class="GridViewLabItemStyle"><input type="text" id="txtQTY"  value="<#=objRow.Quantity#>" max-value="<#=objRow.MaxValue#>"  onlynumber="10" style="width:80px;" onkeypress="$commonJsNumberValidation(event)" onkeydown="$commonJsPreventDotRemove(event)" onkeyup="$updateRowAmount(this,0)" disabled  /></td>    
                        <td class="GridViewLabItemStyle"><input type="text"  id="txtDiscPer" class="BillInfo" value="<#=objRow.DiscPer#>" max-value="100" onlynumber="10" decimalplace="2" style="width:80px;" onkeypress="$commonJsNumberValidation(event)" onkeydown="$commonJsPreventDotRemove(event)" onkeyup="$updateRowAmount(this,0)" disabled  /></td>    
                        <td class="GridViewLabItemStyle"><input type="text"  id="txtDiscAmt" class="BillInfo" value="<#=objRow.DiscAmt#>"  onlynumber="10" decimalplace="2" style="width:80px;" onkeypress="$commonJsNumberValidation(event)" onkeydown="$commonJsPreventDotRemove(event)" onkeyup="$updateRowAmount(this,1)" disabled  /></td>
                        <td class="GridViewLabItemStyle"><input type="text"  id="txtAmount" class="BillInfo" value="<#=objRow.Amount#>"  onlynumber="10" decimalplace="2" style="width:80px;" onkeypress="$commonJsNumberValidation(event)" onkeydown="$commonJsPreventDotRemove(event)" disabled /></td>                         
    ...
    <script type="text/javascript">
        ...
        function getpatientAdvanceAmt(pid)
        {
            var data={
                PatientID:pid,
                PatientRegStatus:1
            ...
            serverCall('../Common/CommonService.asmx/PatientSearchByBarCode', data, function (response) {
                ...
                //alert($responseData.OPDAdvanceAmount);
                $('#spanAdvance').text(Number($responseData[0].OPDAdvanceAmount).toFixed(2));
        ...
        $bindPatientFinalBillAmounts = function (callback) {
            ...
            getpatientAdvanceAmt('<%=ViewState["pid"].ToString()%>');
    ...
    <script type="text/javascript">
        ...
        $UpdateBillDetails = function (btn) {
            ...
            $('#tableitemdetails tbody tr').each(function () {
                if ($(this).find('#cbCheckItem').prop('checked')) {
                    ...
                    if (Number($(this).find('#txtRate').val().trim()) == '0')
                    {
                        RateZero += 1;
                    }
                    $LTD.push({
            ...
            if (RateZero > 0)
            {
                modelAlert(' Please Enter the rate or you can reject the Item.')
                return false;
            }
            if (DiscountReason > 0) {
        ...
        $CloseBilling = function (btn) {
            ...
            if ($('#lblDischargeStatus').text() == 'IN')
            {
                modelAlert('Please  discharge the patient before close the bill...');
                return false;
            }
