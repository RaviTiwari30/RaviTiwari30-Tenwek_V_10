<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdateEmgPanelApproval.aspx.cs" Inherits="Design_Emergency_UpdateEmgPanelApproval" %>
                ...
                <table style="width: 100%; border-collapse: collapse">
                    <tr>
                        ...
                        <td style="width: 35%; text-align: left">
                            ...
                            <asp:DropDownList ID="ddlPanelCompany" runat="server" Width="155px" ></asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td align="right" style="width: 20%">Panel Approval Type :&nbsp;
                        </td>
                        <td style="width: 35%; text-align: left">
                            <asp:RadioButtonList ID="rdoAppType" CssClass="ItDoseRadiobuttonlist" runat="server" RepeatColumns="2" RepeatDirection="Horizontal" ClientIDMode="Static">
                                <asp:ListItem Text="Additional" Value="A"></asp:ListItem>
                    ...
                    <tr>
                        ...
                        <td colspan="3" style="text-align: left">
                            <asp:FileUpload ID="fileUpload1" runat="server" Width="200px" ClientIDMode="Static"  CssClass="requiredField" />
                    ...
                    <tr>
                        <td align="right" style="width: 20%">Amount Approval Type :&nbsp;
                        </td>
                        <td colspan="3" valign="top">
                                    ...
                                    &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;                                   
                                     <div class="Search_Outer_Box" style="clear: both; float: left; width: 486px;">
                                         ...
                                         <asp:RadioButtonList ID="rdoAppWay" runat="server" AutoPostBack="true" RepeatColumns="2" RepeatDirection="Horizontal" OnSelectedIndexChanged="rdoAppWay_SelectedIndexChanged" Width="309px" ClientIDMode="Static">
                                             <asp:ListItem Text="Open Approval" Value="Open"></asp:ListItem>
            ...
            <div class="POuter_Box_Inventory" style="text-align: center;">
                ...
                <asp:GridView ID="grdPanel_App" runat="server" AutoGenerateColumns="False" CssClass="GridViewStyle"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Amt. App. Type">
                            <ItemTemplate>
