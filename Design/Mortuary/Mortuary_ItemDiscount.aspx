<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mortuary_ItemDiscount.aspx.cs" Inherits="Design_Mortuary_Mortuary_ItemDiscount" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#<%=ddlCurrency.ClientID %>').change(function () {
                getCurrencyBase($('#<%=ddlCurrency.ClientID %>').val(), $("#<%=lblBalanceAmt.ClientID %>").text());
...
<body>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            var MaxLength = 200;
            $("#<% =txtNarration.ClientID%>,#<% =txtDisReason.ClientID%>,#<%=txtDisReason1.ClientID %>").bind("cut copy paste", function (event) {
            ...
            if ($("#<%=txtDisReason1.ClientID %>").text().length != null)
                $("#lblremaingCharacters2").html(MaxLength - ($("#<%=txtDisReason1.ClientID %>").text().length));
            else
                $("#lblremaingCharacters2").html(MaxLength);
            $("#<%=txtDisReason1.ClientID %>").bind("keyup keydown", function () {
                var characterInserted = $(this).val().length;
                if (characterInserted > MaxLength) {
                    $(this).val($(this).val().substr(0, MaxLength));
                }
                var characterRemaining = MaxLength - characterInserted;
                $("#lblremaingCharacters2").html(characterRemaining);
            });
            $('#<%=txtNarration.ClientID%>,#<% =txtDisReason.ClientID%>,#<%=txtDisReason1.ClientID %>').bind("keypress", function (e) {
    ...
    <form id="form1" runat="server">
            ...
            <div class="POuter_Box_Inventory" style="text-align: center;">
                ...
                <div class="" style="text-align: center;">
                    <div style="text-align: center;">
                        <asp:GridView ID="grdBasket" Width="100%" runat="server" CssClass="GridViewStyle" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:CommandField ShowSelectButton="True" ItemStyle-CssClass="GridViewItemStyle"
                    ...
                    <asp:Button ID="btnFinalDiscount" runat="server" CssClass="ItDoseButton" OnClick="btnFinalDiscount_Click"
                        Text="Final Bill Discount" OnClientClick="RestrictDoubleEntry(this)" style="display:none;" />
                    </div>
                </div>
            </div>
                ...
                <div class="POuter_Box_Inventory">
                    <table style="width: 960px" cellpadding="0px" cellspacing="0px">
                        ...
                        <tr>
                            ...
                            <td style="text-align: right; width: 10px">
                                <asp:TextBox ID="txtDisAmount1" runat="server" CssClass="ItDoseTextinputNum" Width="90px"
                            ...
                            <td style="width: 20px; text-align: left">
                                <asp:TextBox ID="txtDisPercent1" runat="server" CssClass="ItDoseTextinputNum" Width="60px"
                        ...
                        <tr>
                            ...
                            <td style="text-align: right; width: 10px">
                                <asp:DropDownList ID="ddlApproveBy1" runat="server" Width="107px">
                                </asp:DropDownList>
                            </td>
        ...
        <asp:Panel ID="pnlAddItems" runat="server" CssClass="pnlVendorItemsFilter" Style="display: none; width: 740px; overflow: scroll; height: 400px">
            ...
            &nbsp;&nbsp; <em><span style="font-size: 7.5pt">Press esc or click
                            <img src="../../Images/Delete.gif" style="cursor: pointer" onclick="closeItemsDiscount()" />
                to close</span></em>
            </div>
            <table>
                <tr>
                ...
                <tr>
                    ...
                    <td style="text-align: left">
                        <asp:TextBox ID="txtDisAmount" runat="server" Width="75px" CssClass="ItDoseTextinputNum"
                        ...
                        OR Disc. (%) :&nbsp;
                    <asp:TextBox ID="txtDisPercent" runat="server" Width="75px" CssClass="ItDoseTextinputNum"
