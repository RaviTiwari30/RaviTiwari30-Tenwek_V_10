<%@ Page Language="C#" MasterPageFile="~/DefaultHome.master" AutoEventWireup="true"
    CodeFile="Calender.aspx.cs" Inherits="Design_Physiotherapy_Calender" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
   ...
   #fullcal .fc-agenda-axis, #calendar .fc-widget-header{
...
#fullcal .fc-event-time
{
    display:none;
}
#fullcal .fc-event-title
{
    height:80px;
    width:120px;
}
#fullcal .fc-event-inner
{
    height:80px;
    width:120px;
}
