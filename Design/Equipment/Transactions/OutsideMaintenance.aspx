<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OutsideMaintenance.aspx.cs" Inherits="Design_Equipment_Transactions_OutsideMaintenance" %>
...
<div class="POuter_Box_Inventory">
                ...
                <b>
                        <asp:Label ID="lblMsg0" runat="server" CssClass="ItDoseLblError"></asp:Label>
                            ...
                            <uc1:EntryDate ID="ucrequireddate" runat="server" />
                                                  ...
                                                  <tr>
                                                      <td class="auto-style18">Transfer To Inhouse</td>
                                                      <td class="auto-style8">
                                                          <asp:CheckBox ID="CheckBox1" runat="server" Text="Transfer" AutoPostBack="True" OnCheckedChanged="CheckBox1_CheckedChanged" />
                                                      </td>
                                                      <td class="auto-style9"><asp:Label ID="lbr" runat="server" Text="Reason" Visible="False"></asp:Label></td>
                                                      <td class="auto-style10"><asp:TextBox id="textreason" runat="server" Visible="False" width="200px"></asp:TextBox></td>
        ...
        <div class="POuter_Box_Inventory" style="text-align: center" id="divcost" runat="server">
            ...
            <table style="text-align:left;">
                                                <tr>
                                                    <td class="auto-style17">Material Cost</td>
                                                    <td class="auto-style1">
                                                      <asp:TextBox ID="txtmaterialcost" runat="server" width="150px"></asp:TextBox>
                                                    </td>
                                                    
                                                    <td class="auto-style6">
                                                        Man Power Cost</td>
                                                    <td class="auto-style3">
                                                      <asp:TextBox ID="txtmanpowercost" runat="server" width="150px"></asp:TextBox>
                                                    </td>
                                                  
                                                    <td class="auto-style6">
                                                        External Order Cost</td>
                                                    <td class="auto-style3">
                                                      <asp:TextBox ID="txtothercost" runat="server" width="150px"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                  <tr>
                                                    <td class="auto-style17">Schedule From</td>
                                                    <td class="auto-style1"> 
                                                      
                                                        <uc1:EntryDate ID="ucsfrom" runat="server" />
                                                      </td>
                                                    <td class="auto-style6">Schedule To</td>
                                                    <td class="auto-style3"> 
                                                       
                                                        <uc1:EntryDate ID="ucsto" runat="server" />
                                                      </td>
                                                    <td class="auto-style6"> Approved By</td>
                                                    <td class="auto-style3"> 
                                                  ...
                                                  <tr>
                                                      ...
                                                      <td class="auto-style1">
                                                          <asp:TextBox ID="txtcostremark" runat="server" width="150px"></asp:TextBox>
                                                      </td>
                                                      <td class="auto-style6">Insurance Claim</td>
                                                      <td class="auto-style3"><asp:RadioButton runat="server" ID="rb1" Text="Yes" Checked="True" /><asp:RadioButton ID="rb2" Text="No" runat="server" /></td>
            ...
            <table style="width: 100%;">
                ...
                <tr>
                   ...
                   <div class="POuter_Box_Inventory" style="text-align: center">
               <div class="showheader">Outside Maintenance List</div>
            <div class="content" style="overflow: scroll; height: 150px; width: 95%;">
           
                <asp:GridView ID="gridviewoutdetail" runat="server" AutoGenerateColumns="False" CssClass="GridViewStyle"
                    EnableModelValidation="True" Width="968px" OnRowCommand="gridviewoutdetail_RowCommand"   >
                    <Columns>
                         <asp:TemplateField HeaderText="Show">
                            <ItemStyle HorizontalAlign="Center" CssClass="GridViewItemStyle" />
                            <HeaderStyle CssClass="GridViewHeaderStyle" Width="50px" />
                        ...
                        <asp:TemplateField HeaderText="Material Cost">
                         ...
                         <asp:TemplateField HeaderText="Manpower Cost">
                              <ItemStyle HorizontalAlign="Center" CssClass="GridViewItemStyle" />
                            <HeaderStyle CssClass="GridViewHeaderStyle" />
                         ...
                         <asp:TemplateField HeaderText="External Order Cost">
                              <ItemStyle HorizontalAlign="Center" CssClass="GridViewItemStyle" />
                            <HeaderStyle CssClass="GridViewHeaderStyle"  />
                             <ItemTemplate>
                             <%#Eval("EXTERNAL_ORDER_COST") %>
                             </ItemTemplate>
                         </asp:TemplateField>
                         <asp:TemplateField HeaderText="Schedule From Date">
                             <ItemStyle HorizontalAlign="Center" CssClass="GridViewItemStyle" />
                            <HeaderStyle CssClass="GridViewHeaderStyle"  />
                             <ItemTemplate>
                                <%# Eval("sfrmdate") %>
                        ...
                        <asp:TemplateField HeaderText="Schedule To Date">
                             <ItemStyle HorizontalAlign="Center" CssClass="GridViewItemStyle" />
                            <HeaderStyle CssClass="GridViewHeaderStyle"  />
                             <ItemTemplate>
                                <%# Eval("stodate") %>
