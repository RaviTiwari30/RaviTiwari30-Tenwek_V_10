<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MaintenanceTypeMaster.aspx.cs" Inherits="Design_Equipment_Masters_MaintenanceTypeMaster" %>
                        ...
                        <asp:TemplateField HeaderText="Edit">
                            ...
                            <ItemTemplate>
                                <asp:ImageButton ID="imbEdit" ToolTip="Edit MaintenanceType" runat="server" ImageUrl="~/Images/edit.png" 
                                    CausesValidation="false" CommandArgument='<%# Eval("MaintenanceTypeID")%>' CommandName="EditAT" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Log">
                            ...
                            <ItemTemplate>
                                <asp:ImageButton ID="imbView" ToolTip="View Log Details" runat="server" ImageUrl="~/Images/view.gif" 
                                    CausesValidation="false" CommandArgument='<%# Eval("MaintenanceTypeID")%>' CommandName="ViewLog" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Name">
                            <ItemStyle CssClass="GridViewItemStyle" />
                            <HeaderStyle CssClass="GridViewHeaderStyle" Width="180px" />
                            <ItemTemplate><%#Eval("MaintenanceTypeName") %></ItemTemplate>
                        </asp:TemplateField>
