...
public partial class Design_Equipment_Masters_ProviderInsurance : System.Web.UI.Page
{
    ...
    private string saveprovider()
    {
           ...
           this.IsLocalConn = true;
            ...
            cmd.Parameters.Add(new MySqlParameter("@prdtype", "INS"));
    ...
    {
        string str = "select * from eq_providerinsurance where providertype='INS'";
        DataTable dt = new DataTable();
        dt = StockReports.GetDataTable(str);
    ...
    protected void grddetail_RowCommand(object sender, GridViewCommandEventArgs e)
    {
          ...
          {
              lblLog.Text =   StockReports.ExecuteScalar(@"SELECT CONCAT('Insert By-',em.Name,' Insert Date- ',DATE_FORMAT(insertdate,'%d-%m-%Y')) insertBy  FROM eq_providerinsurance ps INNER JOIN employee_master em ON em.employee_id=ps.insertby WHERE ps.ipcode='" + ipcode + "'");
