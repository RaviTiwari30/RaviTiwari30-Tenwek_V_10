<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AssetScheduling.aspx.cs" Inherits="Design_Equipment_Masters_AssetScheduling" %>
                    ...
                    <table style="text-align: left;">
                        ...
                        <tr>
                            ...
                            <td class="auto-style8">
                                <asp:TextBox ID="txtdept" Width="200px" runat="server" ReadOnly="True"></asp:TextBox></td>
                        ...
                        <tr>
                            ...
                            <td class="auto-style1">
                                <asp:TextBox ID="txtroom" Width="200px" runat="server" ReadOnly="True"></asp:TextBox></td>
            ...
            <div class="POuter_Box_Inventory" style="text-align: center">
                ...
                <table style="text-align: left;">
                    <tr>
                        ...
                        <td class="auto-style6">Schedule Type</td>
                        <td class="auto-style3">
