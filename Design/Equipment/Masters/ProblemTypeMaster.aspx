<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProblemTypeMaster.aspx.cs" Inherits="Design_Equipment_Masters_ProblemTypeMaster" %>
        ...
        <div id="Pbody_box_inventory">
                    ...
                    <table class="ItDoseLabel">
                        ...
                        <tr>
                            ...
                            <td style="text-align: left" colspan="2">
                                <asp:dropdownlist id="ddlCallType" runat="server" cssclass="ItDoseDropdownbox"></asp:dropdownlist>
                            </td>
                        ...
                        <tr>
                            ...
                            <td style="text-align: left" colspan="3">
                                <asp:textbox id="txtDescription" runat="server" width="302px"></asp:textbox>
                            </td>
            ...
            <div class="POuter_Box_Inventory" style="text-align: center">
                ...
                <div class="content" style="overflow: scroll; height: 370px; width: 99%;">
                    <asp:gridview id="grdProblemType" runat="server" autogeneratecolumns="false" cssclass="GridViewStyle" onrowcommand="grdProblemType_RowCommand">
                    <Columns>
                        <asp:TemplateField HeaderText="Edit">
                            <ItemStyle HorizontalAlign="Center" CssClass="GridViewItemStyle" />
                            <HeaderStyle CssClass="GridViewHeaderStyle" Width="50px" />
                            <ItemTemplate>
                                <asp:ImageButton ID="imbEdit" ToolTip="Edit ProblemType" runat="server" ImageUrl="~/Images/edit.png" 
                                    CausesValidation="false" CommandArgument='<%# Eval("ProblemTypeID")%>' CommandName="EditData" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Log">
                            ...
                            <ItemTemplate>
                                <asp:ImageButton ID="imbView" ToolTip="View Log Details" runat="server" ImageUrl="~/Images/view.gif" 
                                    CausesValidation="false" CommandArgument='<%# Eval("ProblemTypeID")%>' CommandName="ViewLog" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Name">
                            ...
                            <ItemTemplate><%#Eval("ProblemTypeName") %></ItemTemplate>
                        </asp:TemplateField>
