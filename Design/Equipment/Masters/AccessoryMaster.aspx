<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccessoryMaster.aspx.cs" Inherits="Design_Equipment_Masters_AccessoryMaster" %>
...
<body style="margin-top: 1px; margin-left: 1px;">
    <form id="form1" runat="server">
        <div id="Pbody_box_inventory">
            ...
            <div class="POuter_Box_Inventory">
                <div>
                    <table class="ItDoseLabel" style="width: 700px;">
                        <tr>
                            <td style="width: 15%; text-align: right;">Name :</td>
                            <td style="width: 25%; text-align: left;">
                                <asp:TextBox ID="txtname" runat="server" Width="150px"></asp:TextBox>
                            </td>
                            <td style="text-align: right; width: 10%;">Code :</td>
                        ...
                        <tr>
                            <td style="width: 15%; text-align: right;">Search Item : </td>
                            <td style="width: 25%; text-align: left;">
                                <asp:TextBox ID="txtSearchItem" runat="server" Width="150px"></asp:TextBox>
                            </td>
                            <td style="text-align: right; vertical-align: central; width: 10%;">
                                <asp:Button ID="btnSearchItem" runat="server" Text="Search" OnClick="btnSearchItem_Click" CssClass="ItDoseButton" />
                            </td>
                            <td colspan="3" style="text-align: left">
                                <asp:DropDownList ID="ddlItem" runat="server" CssClass="ItDoseDropdownbox"></asp:DropDownList>
                            </td>
                        </tr>

                        <tr>
                            <td style="width: 15%; text-align: right;">Description : </td>
                            <td style="width: 10%; text-align: left;" colspan="3">
                                <asp:TextBox ID="txtDescription" runat="server" Width="355px"></asp:TextBox>
                            </td>
            ...
            <div class="POuter_Box_Inventory" style="text-align: center">
                ...
                <div class="content" style="overflow: scroll; height: 370px; width: 99%;">
                    <asp:GridView ID="grdAccessory" runat="server" AutoGenerateColumns="false" CssClass="GridViewStyle" OnRowCommand="grdAccessory_RowCommand">
                        <Columns>
                            <asp:TemplateField HeaderText="Edit">
                                <ItemStyle HorizontalAlign="Center" CssClass="GridViewItemStyle" />
                                <HeaderStyle CssClass="GridViewHeaderStyle" Width="50px" />
                                <ItemTemplate>
                                    <asp:ImageButton ID="imbEdit" ToolTip="Edit Accessory" runat="server" ImageUrl="~/Images/edit.png"
                                        CausesValidation="false" CommandArgument='<%# Eval("AccessoryID")%>' CommandName="EditData" />
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Log">
                                ...
                                <ItemTemplate>
                                    <asp:ImageButton ID="imbView" ToolTip="View Log Details" runat="server" ImageUrl="~/Images/view.gif"
                                        CausesValidation="false" CommandArgument='<%# Eval("AccessoryID")%>' CommandName="ViewLog" />
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Name">
                                ...
                                <ItemTemplate><%#Eval("AccessoryName") %></ItemTemplate>
                            </asp:TemplateField>
