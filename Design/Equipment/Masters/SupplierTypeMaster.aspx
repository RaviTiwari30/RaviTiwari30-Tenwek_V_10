<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SupplierTypeMaster.aspx.cs" Inherits="Design_Equipment_Masters_SupplierTypeMaster" %>
        ...
        <div id="Pbody_box_inventory" style="width: 100%;">
            ...
            <div class="POuter_Box_Inventory" style="text-align: center; width: 100%;">
                <div style="text-align: center">
                    <div class="row">
                        <div class="col-md-4">
                            <label class="pull-left">Supplier Type Name </label>
            ...
            <div class="POuter_Box_Inventory" style="text-align: center; width: 100%;">
                <div style="overflow: scroll; height: 412px; width: 99%;">
                    <asp:GridView ID="grdSupplierType" runat="server" AutoGenerateColumns="false" CssClass="GridViewStyle" OnRowCommand="grdSupplierType_RowCommand">
                        <Columns>
                            <asp:TemplateField HeaderText="Edit">
                                <ItemStyle HorizontalAlign="Center" CssClass="GridViewItemStyle" />
                                <HeaderStyle CssClass="GridViewHeaderStyle" Width="50px" />
                                <ItemTemplate>
                                    <asp:ImageButton ID="imbEdit" ToolTip="Edit SupplierType" runat="server" ImageUrl="~/Images/edit.png"
                                        CausesValidation="false" CommandArgument='<%# Eval("SupplierTypeID")%>' CommandName="EditAT" />
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Log">
                                ...
                                <ItemTemplate>
                                    <asp:ImageButton ID="imbView" ToolTip="View Log Details" runat="server" ImageUrl="~/Images/view.GIF"
                                        CausesValidation="false" CommandArgument='<%# Eval("SupplierTypeID")%>' CommandName="ViewLog" />
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Name">
                                <ItemStyle CssClass="GridViewItemStyle" />
                                <HeaderStyle CssClass="GridViewHeaderStyle" Width="180px" />
                                <ItemTemplate><%#Eval("SupplierTypeName") %></ItemTemplate>
                            </asp:TemplateField>
                            <%--
