<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProviderAMC.aspx.cs" Inherits="Design_Equipment_ProviderAMC" %>
        ...
        <div id="Pbody_box_inventory">
            ...
            <div class="POuter_Box_Inventory">
                ...
                <div class="content" style="text-align: center">
                    <b>AMC Provider Master</b>
                </div>
            </div>
            <div class="POuter_Box_Inventory">
                <div>
                    <div class="showheader">Provider AMC Detail</div>
                    <table class="ItDoseLabel" style="text-align: left; width: 863px;">
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="auto-style1">
                                <asp:TextBox ID="txtname" runat="server" Width="200px" CssClass="ItDoseTextinputText"></asp:TextBox>
                            </td>
                            <td class="auto-style1">Address1:</td>

                            <td class="auto-style1">
                                <asp:TextBox ID="txtadd1" runat="server" Width="200px" CssClass="ItDoseTextinputText"></asp:TextBox>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtadd2" runat="server" Width="200px" CssClass="ItDoseTextinputText"></asp:TextBox>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:TextBox ID="txtpin" runat="server" Width="200px" CssClass="ItDoseTextinputText"></asp:TextBox>
                            ...
                            <td>
                                <asp:TextBox ID="txtph" runat="server" Width="200px" CssClass="ItDoseTextinputText"></asp:TextBox>
                            </td>
                        ...
                        <tr>
                            <td>Fax No:</td>
                            <td>
                                <asp:TextBox ID="txtfax" runat="server" Width="200px" CssClass="ItDoseTextinputText"></asp:TextBox>
                            </td>
                            <td>Mobile:</td>
                            ...
                            <td>
                                <asp:TextBox ID="txtmobile" runat="server" Width="200px" CssClass="ItDoseTextinputText"></asp:TextBox>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtconper1" runat="server" Width="200px" CssClass="ItDoseTextinputText"></asp:TextBox>
                            </td>
                            <td>Email</td>
                            ...
                            <td>
                                <asp:TextBox ID="txtemail" runat="server" Width="200px" CssClass="ItDoseTextinputText"></asp:TextBox>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtconper1desi" runat="server" Width="200px" CssClass="ItDoseTextinputText"></asp:TextBox>
                            </td>
                            ...
                            <td>
                                <asp:TextBox ID="txtconper2" runat="server" Width="200px" CssClass="ItDoseTextinputText"></asp:TextBox>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtconper1email" runat="server" Width="200px" CssClass="ItDoseTextinputText"></asp:TextBox>
                            </td>
                            ...
                            <td>
                                <asp:TextBox ID="txtconper2desi" runat="server" Width="200px" CssClass="ItDoseTextinputText"></asp:TextBox>
                            </td>
                        ...
                        <tr>
                            ...
                            <td style="text-align: left;">
                                <asp:CheckBox ID="chkact" runat="server" Checked="false" />
                            ...
                            <td>
                                <asp:TextBox ID="txtconper2email" runat="server" Width="200px" CssClass="ItDoseTextinputText"></asp:TextBox>
                            </td>
            ...
            <div class="POuter_Box_Inventory" style="text-align: center">
                <div class="showheader">Provider AMC List</div>
                <div class="content" style="overflow: scroll; height: 200px; width: 97%;">
