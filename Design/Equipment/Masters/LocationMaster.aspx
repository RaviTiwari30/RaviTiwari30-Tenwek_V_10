<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LocationMaster.aspx.cs" MasterPageFile="~/DefaultHome.master" Inherits="Design_Equipment_Masters_LocationMaster" %>
         ...
         <div id="Pbody_box_inventory">
            ...
            <div class="POuter_Box_Inventory" >
             ...
             <div class="POuter_Box_Inventory" style="text-align: center;">
                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                            <asp:TextBox ID="txtDescription" runat="server" CssClass="ItDoseTextinputText" ></asp:TextBox>
                        </div>
                 ...
                 <div class="row">
                    ...
                    <div class="col-md-5" style="display:none">
                            <asp:DropDownList ID="ddlFloor" runat="server" CssClass="requiredField">
                                </asp:DropDownList>
            ...
            <div class="POuter_Box_Inventory" style="text-align: center; ">
                <div class="content" style="overflow: scroll; height: 380px; width: 99%;">
                    <asp:GridView ID="grdLocation" runat="server" AutoGenerateColumns="false" CssClass="GridViewStyle" OnRowCommand="grdLocation_RowCommand">
                        <Columns>
                            <asp:TemplateField HeaderText="Edit">
                                <ItemStyle HorizontalAlign="Center" CssClass="GridViewItemStyle" />
                                <HeaderStyle CssClass="GridViewHeaderStyle" Width="50px" />
                                <ItemTemplate>
                                    <asp:ImageButton ID="imbEdit" ToolTip="Edit Location" runat="server" ImageUrl="~/Images/edit.png"
                                        CausesValidation="false" CommandArgument='<%# Eval("LocationID")%>' CommandName="EditData" />
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Log">
                                ...
                                <ItemTemplate>
                                    <asp:ImageButton ID="imbView" ToolTip="View Log Details" runat="server" ImageUrl="~/Images/view.GIF"
                                        CausesValidation="false" CommandArgument='<%# Eval("LocationID")%>' CommandName="ViewLog" />
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField Visible="false" HeaderText="FloorName">
                                <ItemStyle CssClass="GridViewItemStyle" />
                                <HeaderStyle CssClass="GridViewHeaderStyle" Width="180px" />
