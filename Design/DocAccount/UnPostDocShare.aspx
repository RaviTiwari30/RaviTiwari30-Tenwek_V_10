<%@ Page Language="C#" MasterPageFile="~/DefaultHome.master" AutoEventWireup="true" CodeFile="UnPostDocShare.aspx.cs" Inherits="Design_DocAccount_UnPostDocShare" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="Pbody_box_inventory">
        ...
        <div class="POuter_Box_Inventory">
          ...
          <div class="POuter_Box_Inventory" style="text-align: center;">
            <input type="button" class="ItDoseButton" id="btnUnPost" value="Un Post Doctor Share" title="Click to Un Post Doctor Share" onclick="unPostDoctorShare(this);" />
        </div>
    </div>
        <script type="text/javascript">
            ...
            function bindUnPostDate() {
                var mode = $("#rblMode input[type='radio']:checked").val();
                $.ajax({
                    url: "Services/DocAccount.asmx/bindUnPostDate",
                    data: '{}',
                    type: "POST",
                    ...
                    success: function (result) {
                        ...
                        $('#btnSearch').attr('disabled', false);
                            ...
                            $("#lblmsg").text('Please Post Doctor Share');
            ...
            var unPostDoctorShare = function (btnSave) {

                if ($("#ddlDoctor option:selected").text() == "--No Data--") {
                    $("#lblmsg").text('There are No doctor available for un-posting the doctor share!');
                    return false;
                }
                ...
                serverCall('Services/DocAccount.asmx/PostDoctorShareNew', data, function (resposne) {
                    ...
                    modelAlert(responseData.response, function () {
                        if (responseData.status)
                            ...
                            $(btnSave).removeAttr('disabled').val('Un Post Doctor Share');
                    });
                });
            }
    </script>
