<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PharmacyFinalSettlement.aspx.cs"
    Inherits="Design_Store_OPDFinalSettlement" MasterPageFile="~/DefaultHome.master"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="Pbody_box_inventory">
        ...
        <div class="POuter_Box_Inventory" style="text-align: center;">
            <b>Pharmacy Final Settlement</b><br />
            ...
            <table style="width: 90%;border-collapse:collapse">
                ...
                <tr>
                    ...
                    <td style="width: 15%; text-align: left; ">
                        <asp:TextBox ID="txtPatientID" runat="server" AutoCompleteType="Disabled" TabIndex="1" ClientIDMode="Static"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField Visible="false">
                                <ItemTemplate>
                                    ...
                                    <asp:Label ID="lblOTCollection" runat="server" Text='<%# Eval("IsOTCollection") %>' Visible="False"></asp:Label>
                             ...
                             <asp:TemplateField HeaderText="View" >
                                ...
                                <ItemTemplate>
                                     <asp:Label ID="lblLedTnxNoView" runat="server" ClientIDMode="Static" style="display:none" Text='<%# Eval("LedgertransactionNo") %>'
                                       ></asp:Label>
                                   <img id="imgView" src="../../Images/view.GIF" onclick="viewDetail(this)" style="cursor:pointer" title="Click To View Detail" />
                                </ItemTemplate>
                            </asp:TemplateField>
                    ...
                    <tr>
                        ...
                        <td style="width: 10%; text-align: right"><asp:Label ID="lblTypeOfTnx" runat="server" Visible="false"></asp:Label>
                            <asp:Label ID="lblDeptLedgerNo" runat="server" Visible="false"></asp:Label>
                             <asp:Label ID="lblIsOTCollection" runat="server" Visible="false"></asp:Label>
                        </td>
                        <td style="width: 40%; text-align: left"></td>
    ...
    <script type="text/javascript">
        function viewDetail(rowID) {
            ...
            var ledgerTransactionNo = $(row).find('#lblLedTnxNoView').text();

            $.ajax({
                url: "PharmacyFinalSettlement.aspx/getItemDetail",
                data: '{ledgerTransactionNo:"' + ledgerTransactionNo + '"}',
                type: "POST",
                async: true,
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (mydata) {
                    ...
                    var resultDiv = "<div style='text-align: right; position: absolute; right:5px; top:2px'><img alt='Close' src='../../Images/Delete.gif' style='cursor:pointer' onclick='HideDivHistory();' /></div><div id='Pbody_box_inventory' style='width:680px;'>";
                    resultDiv += "<div style='text-align: center; width: 99%;' class='POuter_Box_Inventory'><b>Item Detail</b></div>";
                    resultDiv += "<div class='POuter_Box_Inventory' style='width: 99%;'> <table class='GridViewStyle' style='width: 100%'><tr class='GridViewHeaderStyle'><th style='width: 5%;text-align: center'>S.No.</th><th style='width: 42%;text-align: left'>Item</th><th style='width: 8%'>Batch No.</th><th style='width: 10%'>Quantity</th><th style='width: 10%'>Rate</th>";
                    for (var i = 0; i < resultObj.length; i++) {
                        resultDiv += "<tr class='GridViewItemStyle'><td style='width: 5%;text-align: center'>" + (i + 1) + "</td><td style='width: 42%'> " + resultObj[i].Item + "</td><td style='width: 10%;text-align: center'>" + resultObj[i].BatchNumber + "</td><td style='width: 8%;text-align: center'>" + resultObj[i].Quantity + "</td><td style='width: 10%;text-align: center'>" + resultObj[i].Rate + "<br /></td></tr>";
                    }
