<%@ Page Language="C#" MasterPageFile="~/DefaultHome.master" AutoEventWireup="true"
    CodeFile="InternalStockTransferGeneral.aspx.cs" Inherits="Design_Store_InternalStockTransferGeneral" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            $.ajax({
                ...
                success: function (mydata) {
                    ...
                    if (data == false) {
                        ...
                        $('#<%=btnSave.ClientID %>,#<%=btnA.ClientID %>,#btnSearchIndent,#<%=btnNA.ClientID %>,#<%=btnRN.ClientID %>,#<%=btnSN.ClientID %>').attr('disabled', 'disabled');
    ...
    <div id="Pbody_box_inventory">
        ...
        <div class="POuter_Box_Inventory">
            ...
            <div style="text-align: center; margin-left: 90px;">
                ...
                <table style="width: 100%; border-collapse: collapse">
                    <tr>
                        <td style="width: 12%; text-align: right">Date From :&nbsp;
                        </td>
                        ...
                        <td style="width: 12%; text-align: right">Date To :&nbsp;
                        </td>
                        <td style="width: 25%; text-align: left">
                            <asp:TextBox ID="DateTo" runat="server" ClientIDMode="Static" CssClass="ItDoseTextinputText"
                                Width="149px">
                            </asp:TextBox>
                    ...
                    <tr>
                        <td style="width: 12%; text-align: right">Department :&nbsp;
                        </td>
                        <td style="width: 25%; text-align: left">
                            <asp:DropDownList ID="ddlDepartment" runat="server" Width="156px">
                            </asp:DropDownList>
                        </td>
                        <td style="width: 15%; text-align: right">Requisition No. :&nbsp;
                        </td>
                        <td style="width: 25%; text-align: left">
                    ...
                    <tr>
                        <td style="width: 12%; text-align: right">Centre Name :&nbsp;</td>
                        <td style="width: 25%; text-align: left">
                            <asp:DropDownList ID="ddlCentre" runat="server" Width="156px"></asp:DropDownList>
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="height: 26px; text-align: center" colspan='2'>
                            <asp:Button ID="btnSearchIndent" runat="server" Text="Search Requisition Details"
                                OnClick="btnSearchIndent_Click1" ClientIDMode="Static" CssClass="ItDoseButton" />
                        </td>
                        <td style="height: 26px">
                            <asp:TextBox ID="txtIndentNo" runat="server" CssClass="ItDoseTextinputText" ReadOnly="true"
                                Visible="false">
                            </asp:TextBox>
                        </td>
                    </tr>
                    ...
                    <table width="200px">
                        ...
                        <td>Open</td>
                            <td style="height: 22px; width: 74px;" >
                                <asp:Button ID="btnSN" runat="server"  Width="20px" Height="20px"  BackColor="pink" BorderStyle="Solid" BorderColor="Black" CssClass="ItDoseButton11" /></td>
                        </tr>
                    </table>
            </div>--%>
                <div class="content" style="text-align: center;">
                            ...
                            <asp:TemplateField HeaderText="View" HeaderStyle-Width="20px">
                                <ItemTemplate>
                                    <asp:ImageButton ID="imbView" runat="server" CausesValidation="false" CommandName="AView"
                                        ImageUrl="~/Images/view.gif" CommandArgument='<%# Eval("IndentNo")+"#"+Eval("DeptFrom")+"#"+Eval("StatusNew") +"#"+Eval("CentreID") %>' Visible='<%#Util.GetBoolean(Eval("VIEW")) %>' />
                                    <asp:Label ID="lblIsNewIndent" Visible="false" runat="server" Text='<%#Eval("NewIndent") %>'></asp:Label>
                                </ItemTemplate>
                                <ItemStyle CssClass="GridViewItemStyle" />
                        ...
                        <HeaderTemplate>
                            <table class="GridViewStyle" cellspacing="0" style="border-collapse: collapse;">
                                <tr style="text-align: center; background-color: #afeeee;">
                                    ...
                                    <th class="GridViewHeaderStyle" scope="col">Approved Qty.
                                    </th>
                                    ...
                                    <th class="GridViewHeaderStyle" scope="col">Collected By
                                    </th>
                        ...
                        <ItemTemplate>
                            <tr>
                                <td class="GridViewItemStyle">
                                    ...
                                    <asp:Label ID="lblCentreID" runat="server" Text='<%# Eval("CentreID") %>' Visible="false"></asp:Label>
                                <asp:Label ID="lblHospCentreID" runat="server" Text='<%# Eval("HospCentreID") %>' Visible="false"></asp:Label>
                                </td>
                                <td class="GridViewItemStyle">
                                ...
                                <td class="GridViewItemStyle">
                                    <asp:Label ID="lblApprovedQty" runat="server" Text='<%# Eval("ApprovedQty") %>'></asp:Label>
                                </td>
                                <td class="GridViewItemStyle">
                                ...
                                <td class="GridViewItemStyle">
                                    <asp:TextBox ID="txtCollectedBy" runat="server" CssClass="ItDoseTextinputText" Width="100px" MaxLength="50"></asp:TextBox>
                                </td>
                                <td class="GridViewItemStyle">
                                    ...
                                    <asp:Repeater ID="grdItem" OnItemCommand="grdItem_ItemCommand" runat="server">
                                        <HeaderTemplate>
                                            <table class="GridViewStyle" style="border-collapse: collapse; width: 100%">
                                                <tr style="text-align: center; background-color: #afeeee; width: 100%">
                                                    ...
                                                    <th class="GridViewHeaderStyle" scope="col">Cost Price
                                                    </th>
                                                ...
                                                <td colspan="9">
                                                    <asp:GridView ID="grdItemNew" class="grdn" runat="server" Visible="false" AutoGenerateColumns="False"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="IsExpirable" HeaderStyle-Width="100px" ItemStyle-CssClass="GridViewItemStyle"
                                                                HeaderStyle-CssClass="GridViewHeaderStyle">
                                                                <ItemTemplate>
                                                                    <%#Eval("IsExpirable")%>
                                                                </ItemTemplate>
                                                            ...
                                                            <asp:TemplateField HeaderText="Cost Price" Visible="false" HeaderStyle-Width="50px"
                                                ...
                                                <td colspan="9" style="text-align: center;">
                                                    <asp:GridView ID="grdItemNewgenric" runat="server" Visible="false" AutoGenerateColumns="False"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="BuyPrice" Visible="false" HeaderStyle-Width="50px"
                                                                ItemStyle-CssClass="GridViewItemStyle" HeaderStyle-CssClass="GridViewHeaderStyle">
                                                                <ItemTemplate>
                                                            ...
                                                            <asp:TemplateField HeaderText="Issue Qty." HeaderStyle-Width="75px" ItemStyle-CssClass="GridViewItemStyle"
                                                                HeaderStyle-CssClass="GridViewHeaderStyle">
                                                                <ItemTemplate>
        ...
        <asp:Panel ID="Panel2" runat="server" CssClass="pnlItemsFilter" Style="display: none; width: 950px; height: 350px;"
            ScrollBars="Auto">
            <div>
                <table>
                    <tr>
                    ...
                    <tr>
                        <td valign="top" style="text-align: center;">
                            <asp:GridView ID="grdIndentdtl" runat="server" CssClass="GridViewStyle" AutoGenerateColumns="False"
                                Width="940px" OnRowDataBound="grdIndentdtl_RowDataBound">
                                <AlternatingRowStyle CssClass="GridViewAltItemStyle" />
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Approved Qty." DataField="ApprovedQty" ItemStyle-CssClass="GridViewItemStyle"
                                        HeaderStyle-CssClass="GridViewHeaderStyle" />
                                    <asp:BoundField HeaderText="Cancelled Qty." DataField="CancelQty" ItemStyle-CssClass="GridViewItemStyle"
                                        HeaderStyle-CssClass="GridViewHeaderStyle" />
                                    <asp:BoundField HeaderText="Approved /Cancelled By" DataField="Approve_CancelBy" ItemStyle-CssClass="GridViewItemStyle"
                                        HeaderStyle-CssClass="GridViewHeaderStyle" />
                                    <asp:BoundField HeaderText="Issue Quantity" DataField="SoldUnits" ItemStyle-CssClass="GridViewItemStyle"
                                        HeaderStyle-CssClass="GridViewHeaderStyle" />
                                    ...
                                    <asp:BoundField HeaderText="Date" DataField="DATE" ItemStyle-CssClass="GridViewItemStyle"
                                        HeaderStyle-CssClass="GridViewHeaderStyle" ItemStyle-Wrap="false"/>
                                    ...
                                    <asp:BoundField HeaderText="CollectedBy" DataField="CollectedBy" ItemStyle-CssClass="GridViewItemStyle"
                                        HeaderStyle-CssClass="GridViewHeaderStyle" ItemStyle-Width="90px" />
                                    <asp:BoundField HeaderText="Received" DataField="Received" ItemStyle-CssClass="GridViewItemStyle"
                                        HeaderStyle-CssClass="GridViewHeaderStyle" ItemStyle-Width="90px" />
                                    <asp:BoundField HeaderText="ReceivedBy" DataField="ReceivedBy" ItemStyle-CssClass="GridViewItemStyle"
                                        HeaderStyle-CssClass="GridViewHeaderStyle" ItemStyle-Width="90px" />
                                    <asp:BoundField HeaderText="ReceivedDate" DataField="ReceivedDate" ItemStyle-CssClass="GridViewItemStyle"
                                        HeaderStyle-CssClass="GridViewHeaderStyle" ItemStyle-Wrap="true" />
                                </Columns>
                            </asp:GridView>
                        </td>
                    </tr>
