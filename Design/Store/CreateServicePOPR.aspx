<%@ Page Title="" Language="C#" MasterPageFile="~/DefaultHome.master" AutoEventWireup="true" CodeFile="CreateServicePOPR.aspx.cs" Inherits="Design_Store_CreateServicePOPR" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        var getDepartMent = function (callback) {
          //  $('#ddlDepartmentTo')();
            serverCall('Services/CommonService.asmx/GetDepartMentCentreWise', { CentreID: $('#ddlCenterTo').val() }, function (response) {
                var responseData = JSON.parse(response);
                callback($('#ddlDepartmentTo').bindDropDown({ defaultValue: 'Select', data: JSON.parse(response), valueField: 'DeptLedgerNo', textField: 'RoleName', isSearchAble: true }));
            });
        }
        ...
        var configureTable = function (s) {
            ...
            hTables.addHook('beforeChange', function (changes, source) {
                ...
                var h = this;
                var quantityTypes = ['Quantity', 'IndentQuantity', 'SalesQuantity'];
                if (prop === 'ItemName') {
                    ...
                    getItemStockDetails(selectedData.ItemID, function (itemDetails) {
                        ...
                        h.setDataAtRowProp(row, h.propToCol('IndentNumber'), '');
                        h.setDataAtCell(row, h.propToCol('IndentQuantity'), 0);
        ...
        var getGridSetting = function (callback) {
            ...
            var s = {
                ...
                colWidths: [320, 55, 76, 85, 65, 63, 68, 50, 100, 100, 80, 150],
    ...
    <div id="Pbody_box_inventory">
        ...
        <div class="POuter_Box_Inventory" style="text-align: center;">
            <b id="pageTitle">Create Service Items Purchase Request</b>
        </div>
		...
		<div class="col-md-3">
            ...
            <div class="row">
                <div class="col-md-24">
                    <input type="button" class="pull-right" style="margin-right: 5px;" onclick="onSearchRequisitionModelOpen()" value="Add Pending Indents." />
                    <input type="button" class="pull-right" style="margin-right: 5px;" onclick="getAutoPurchaseRequestItemsOnSales()" value="Auto Purchase Request On ReOrder Level" />
                </div>
            </div>
        </div>
        <div class="POuter_Box_Inventory">
