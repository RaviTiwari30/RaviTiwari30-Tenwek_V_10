<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PostOPRecord.aspx.cs" Inherits="Design_OT_PostOPRecord" %>
        ...
        var Doctor = {
            ...
            success: function (result) {
                ...
                if (Doctor != null) {
                    ...
                    $(".ddlDoctor").append(jQuery("<option></option>").val("SELECT").html("ALL"));
                    if (Doctor.length == 0) {
            ...
            <div class="POuter_Box_Inventory">
                 <div class="row">
                    <div class="col-md-25" style="display: block;">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <label class="pull-left">Returned Ward</label>
                                <b class="pull-right">:</b>
                            </div>
                            <div class="col-md-7">
                                <asp:TextBox ID="txtReturnedWard" runat="server" ClientIDMode="Static"></asp:TextBox>
                            </div>
                            <div class="col-md-5">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <label class="pull-left">Time Fully Conscious</label>
                                <b class="pull-right">:</b>
                            </div>
                            <div class="col-md-7">
                                 <asp:TextBox ID="txtTimeFullyConscious" runat="server" ClientIDMode="Static"></asp:TextBox>
                            </div>
                             <div class="col-md-5">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <label class="pull-left">Post Op Medication:Name of Drugs,Dose,time,Signature</label>                              
                            </div>
                            <div class="col-md-2">
                               <b class="pull-right">:</b>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <label class="pull-left">Antiemetic</label>                           
                            </div>
                             <div class="col-md-2">
                               <b class="pull-right">:</b>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <label class="pull-left">Reports</label>                           
                            </div>
                             <div class="col-md-2">
                               <b class="pull-right">:</b>
                            </div>
                            <div class="col-md-12">
                                <asp:TextBox ID="txtReport" runat="server" TextMode="MultiLine" Height="175px" ></asp:TextBox>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="POuter_Box_Inventory" style="text-align: center">
                <asp:GridView ID="grdPhysical" runat="server" AutoGenerateColumns="False" CssClass="GridViewStyle" OnRowCommand="grdPhysical_RowCommand" TabIndex="6">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="ReturnedWard">
                            <ItemTemplate>
                                <%#Eval("ReturnedWard") %>
                            </ItemTemplate>
                            <ItemStyle CssClass="GridViewItemStyle" />
