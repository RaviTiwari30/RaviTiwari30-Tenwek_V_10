<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DisplayOTScreen.aspx.cs" Inherits="Design_IPD_DisplayOTScreen" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function BindData() {
            ...
            $.ajax({
                url: "DisplayOTScreen.aspx/BindWardData",
                data: '{WardID:"' + WardID + '"}',
                type: "POST",
                   ...
                   <table  id="tbl_Doctors" style="width:100%;" class="tbPatient"  border="0">
                      <thead>
                         <tr>
				            ...
				            <th style="text-align:left;width:8%;">Doctor</th>
				           <%-- <th style="text-align:left;width:10%;">Panel</th>
				            <th style="text-align:left;width:10%;">Room Name</th>--%>
                            <th style="text-align:left;width:8%;">Ward Name</th>
                            <%--<th style="text-align:left;width:10%;">Admitted By</th>--%>
                            <th style="text-align:left;width:4%;">OT</th>
                            <th style="text-align:left; width:10%">StartTime</th>
                             <th style="text-align:left; width:10%">EndTime</th>
                         </tr> 
                      </thead>
                     <tbody>
                         <#
                         ...
                         <tr class="Doctor">
				            ...
				            <td  id="tdPName" style="width:12%;text-align:left;" ><#=objRow.PName#></td>
				            <td  id="tdSex" style="width:8%;text-align:left;" ><#=objRow.AgeSex#></td>
				            <td  id="tdDoctor" style="width:15%;text-align:left;" ><#=objRow.DName#></td>
                            ...
                            <td id="tdOT" style="width:4%; text-align:left"><#=objRow.ot#></td>          
                            <td id="tdOTStartTime" style="width:10%; text-align:left"><#=objRow.StartTime#></td>       
                            <td id="tdOTEndTime" style="width:10%; text-align:left"><#=objRow.EndTime#></td>
                        </tr>                       
                        <#}                        
                        #>
                    </tbody>
