<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IntraOPVitalSignEntry.aspx.cs" Inherits="Design_IPD_IntraOPVitalSignEntry" %>
...
<body>
    ...
    <script type="text/javascript">
        ...
        <script type="text/javascript">
            ...
            $(function () {
                $("#txtTemp,txtPulse").keypress(function (e) {
            ...
            function Bindgraph_Pulse() {
                var TID = "<%=Request.QueryString["TransactionID"]%>";
                        $.ajax({
                            url: "IntraOPVitalSignEntry.aspx/Bindgraph_Pulse",
                            data: '{TID:"' + TID + '"}',
                            type: "POST",
                            async: true,
                            dataType: "json",
            ...
            function Bindgraph_BP() {
                var TID = "<%=Request.QueryString["TransactionID"]%>";
                 $.ajax({
                     url: "IntraOPVitalSignEntry.aspx/Bindgraph_BP",
                     data: '{TID:"' + TID + '"}',
                     type: "POST",
                     async: true,
                     dataType: "json",
        ...
        <div id="Pbody_box_inventory">
                    ...
                    <div class="col-md-24">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                ...
                                <span class="auto-style7">bpm</span>
                            </div> 
                        </div>
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-md-5">
                                <asp:TextBox ID="txtPAW" runat="server" Width="70px"></asp:TextBox>                                
                            </div>
                            <div class="col-md-3">
                                <label class="pull-left">
                                    CVP
                            ...
                            <div class="col-md-5">
                                <asp:TextBox ID="txtCVP" runat="server" Width="70px"></asp:TextBox>                               
                            </div>                                                    
                            <div class="col-md-3">
                                <label class="pull-left">
                                    Temp
                        ...
                        <div class="row" >                           
                            ...
                            <div class="col-md-5">
                                <asp:TextBox ID="txtWeight" ClientIDMode="Static"  max-value="10000" runat="server" Width="70px"></asp:TextBox>                               
                            </div>
                            <div class="col-md-3">
                                <label class="pull-left">
                                    Blood 
                            ...
                            <div class="col-md-5">
                                <asp:TextBox ID="txtPOD" runat="server" Width="70px"></asp:TextBox>
                            </div>
                        </div>
                        <div class="row">                            
                             <div class="col-md-3">
                            ...
                            <div class="col-md-5">
                                <asp:TextBox ID="txtHeight"  ClientIDMode="Static" runat="server" Width="70px"></asp:TextBox>
                            </div>
                        </div>
                         <div class="row">
                            <div class="col-md-3">
            ...
            <div class="POuter_Box_Inventory" style="text-align: center">
                ...
                <asp:Button ID="btnUpdate" ClientIDMode="Static" runat="server"  OnClick="btnUpdate_Click" Text="Update" Visible="false" CssClass="ItDoseButton" TabIndex="69" OnClientClick="return note();" />
                            ...
                            <div style="text-align: center;">
                                <asp:GridView ID="grdNursing" runat="server" AutoGenerateColumns="False" CssClass="GridViewStyle" OnRowDataBound="grdNursing_RowDataBound" OnRowCommand="grdNursing_RowCommand" OnPageIndexChanging="OnPageIndexChanging" AllowPaging="true" PagerSettings-PageButtonCount="5">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="FIO2" Visible="true">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="SPO2">
                                         ...
                                         <asp:TemplateField HeaderText="EICO2" Visible="true">
                                            <ItemTemplate>
                                         ...
                                         <asp:TemplateField HeaderText="PAW" Visible="true">
                                            <ItemTemplate>
                                                <asp:Label ID="lblPAW" runat="server" Text='<%#Eval("PAW") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle CssClass="GridViewItemStyle" />
                                            <HeaderStyle CssClass="GridViewHeaderStyle" />
                                        </asp:TemplateField>
                                         <asp:TemplateField HeaderText="CVP" Visible="true">
                                            <ItemTemplate>
                                                <asp:Label ID="lblCVP" runat="server" Text='<%#Eval("CVP") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle CssClass="GridViewItemStyle" />
                                            <HeaderStyle CssClass="GridViewHeaderStyle" />
                                        </asp:TemplateField>
                                         <asp:TemplateField HeaderText="Temp" Visible="true">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Crystalloids" Visible="true">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Colloid" Visible="true">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="BLOOD" Visible="true">
                                            <ItemTemplate>
                                         ...
                                         <asp:TemplateField HeaderText="B Loss">
                                            <ItemTemplate>
