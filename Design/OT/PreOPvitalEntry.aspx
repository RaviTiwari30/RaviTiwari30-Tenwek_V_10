<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PreOPvitalEntry.aspx.cs" Inherits="Design_OT_PreOPvitalEntry" %>
    ...
    <form id="form1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function Bindgraph_Pulse() {
                ...
                $.ajax({
                    url: "PreOPvitalEntry.aspx/Bindgraph_Pulse",
                    data: '{TID:"' + TID + '"}',
                    type: "POST",
                    async: true,
                    dataType: "json",
            ...
            function Bindgraph_BP() {
                var TID = "<%=Request.QueryString["TransactionID"]%>";
                $.ajax({
                    url: "PreOPvitalEntry.aspx/Bindgraph_BP",
                    data: '{TID:"' + TID + '"}',
                    type: "POST",
                    async: true,
                    dataType: "json",
