...
<div>
<asp:DropDownList ID="ddlDate" Visible="False" runat="server" Width="15%" CssClass="opdsearchbox6" >
...
<asp:DropDownList ID="ddlMonth" runat="server" Width="30%" CssClass="opdsearchbox6" >
<asp:ListItem Selected="True" >-</asp:ListItem>
...
<asp:DropDownList ID="ddlYear" runat="server" Width="30%" CssClass="opdsearchbox6" >
<asp:ListItem Selected="True" >-</asp:ListItem>
