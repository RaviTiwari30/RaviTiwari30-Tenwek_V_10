<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MISIPDDischargeAnalysis.aspx.cs"
    Inherits="Design_MIS_MISIPDDischargeAnalysis" %>
...
<body>
    ...
    $(document).ready(function() {
        ...
        $('#<%=grdDischargeTypeC.ClientID %>').Scrollable({ScrollHeight: 200});
        $('#<%=grdPanelC.ClientID %>').Scrollable({ScrollHeight: 200});
            ...
            <table cellpadding="0" cellspacing="0" style="width: 100%; height: 100%">
                ...
                <tr>
                    <td style="width: 50%;">
                        <asp:GridView ID="grdDischargeTypeC" runat="server" AutoGenerateColumns="False" CssClass="GridViewStyle"
                            Width="465px" OnRowCommand="grdDischargeTypeC_RowCommand" OnRowDataBound="grdDischargeTypeC_RowDataBound">
                            <Columns>
                                <asp:TemplateField HeaderText="#">
                                    <ItemStyle Width="25px" />
                                    <HeaderStyle CssClass="GridViewHeaderStyle" Width="25px" />
                                ...
                                <asp:TemplateField HeaderText="V">
                                    ...
                                    <HeaderStyle CssClass="GridViewHeaderStyle" Width="10px" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblCompDischargeType" runat="server" Visible="false" Text='<%# Eval("CompType") %>' />
                                        <asp:Label ID="lblDischargeTypeQtyGrowth" runat="server" Visible="false" Text='<%# Eval("QtyGrowth") %>' />
                                        <asp:ImageButton ID="imbView" ToolTip="View Details" runat="server" ImageUrl="~/Images/view.GIF"
                                            CausesValidation="false" CommandArgument='<%# Eval("DischargeType")+"#"+Eval("CompType")%>' CommandName="View" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
                    ...
                    <td style="width: 100%">
                       <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False" width="850px"
                        CssClass="GridViewStyle" ShowFooter="true" >
                            ...
                            <Columns>
                                <asp:BoundField DataField="IP_No" HeaderText="IP_No">
                                ...
                                <HeaderStyle CssClass="GridViewHeaderStyle" Width="120px" />
                                 ...
                                 <asp:BoundField DataField="AdmitDate" HeaderText="AdmitDate">
                                 <HeaderStyle CssClass="GridViewHeaderStyle" Width="100px" />
                                    <ItemStyle CssClass="GridViewItemStyle" HorizontalAlign="Left" Width="100px" />
                                    
                                    <FooterStyle CssClass="GridViewFooterStyle" Width="100px" />
                                </asp:BoundField>
                                 <asp:BoundField DataField="AdmitTime" HeaderText="AdmitTime">
                                 <HeaderStyle CssClass="GridViewHeaderStyle" Width="100px" />
                                    <ItemStyle CssClass="GridViewItemStyle" HorizontalAlign="Left" Width="100px" />
                                ...
                                <asp:BoundField DataField="DischargeType" HeaderText="DischargeType">
                                <HeaderStyle CssClass="GridViewHeaderStyle" Width="100px" />
                                    <ItemStyle CssClass="GridViewItemStyle" HorizontalAlign="Left" Width="100px" />
                                    
                                    <FooterStyle CssClass="GridViewFooterStyle" Width="100px" />
                                </asp:BoundField>
                                <asp:BoundField DataField="AdmittedIn" HeaderText="AdmittedIn">
                                <HeaderStyle CssClass="GridViewHeaderStyle" Width="120px" />
                                    <ItemStyle CssClass="GridViewItemStyle" HorizontalAlign="Left" Width="120px" />
                                    
                                    <FooterStyle CssClass="GridViewFooterStyle" Width="120px" />
                                </asp:BoundField>
                                <asp:BoundField DataField="DischargeFrom" HeaderText="DischargeFrom">
                                <HeaderStyle CssClass="GridViewHeaderStyle" Width="120px" />
                                    <ItemStyle CssClass="GridViewItemStyle" HorizontalAlign="Left" Width="120px" />
                                    
                                    <FooterStyle CssClass="GridViewFooterStyle" Width="120px" />
                                </asp:BoundField>
                                <asp:BoundField DataField="DatewiseStay" HeaderText="DatewiseStay">
                                <HeaderStyle CssClass="GridViewHeaderStyle" Width="100px" />
                                    <ItemStyle CssClass="GridViewItemStyle" HorizontalAlign="Left" Width="100px" />
                                 ...
                                 <asp:BoundField DataField="HourlyStay" HeaderText="HourlyStay">
                                 <HeaderStyle CssClass="GridViewHeaderStyle" Width="100px" />
                                    <ItemStyle CssClass="GridViewItemStyle" HorizontalAlign="Left" Width="100px" />
