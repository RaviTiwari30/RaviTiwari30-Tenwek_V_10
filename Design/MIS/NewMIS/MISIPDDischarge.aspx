<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MISIPDDischarge.aspx.cs" Inherits="Design_MIS_MISIPDDischarge" %>
...
$('#<%=grdDischargeType.ClientID %>').Scrollable({ScrollHeight: 200});
$('#<%=grdPanel.ClientID %>').Scrollable({ScrollHeight: 200});
      ...
      <table cellpadding="0" cellspacing="0" style="width: 100%; height: 100%">
                                ...
                                <tr>
                                    <td style="width: 50%; text-align: center;" valign="top">
                                        <asp:Label ID="lblGroup" runat="server" ForeColor="Maroon" Font-Bold="true" Text="Discharge-wise"></asp:Label>
                                    </td>
                                    <td style="width: 50%; text-align: center;" valign="top">
                                ...
                                <tr>
                                    <td style="width: 50%; ">
                                        <asp:GridView ID="grdDischargeType" runat="server" AutoGenerateColumns="False" CssClass="GridViewStyle"
                                            Width="465px" OnRowCommand="grdDischargeType_RowCommand">
                                            <AlternatingRowStyle CssClass="GridViewAltItemStyle" />
                                            <Columns>
                                                <asp:TemplateField HeaderText="S.No.">
                                                    <ItemStyle CssClass="GridViewItemStyle" Width="25px" />
                                                ...
                                                <asp:TemplateField HeaderText="V" >
                                                    ...
                                                    <HeaderStyle CssClass="GridViewHeaderStyle" Width="10px" />
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="imbView" ToolTip="View Details" runat="server" ImageUrl="~/Images/view.GIF" CausesValidation="false" CommandArgument='<%# Eval("DischargeType")%>' CommandName="View" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
