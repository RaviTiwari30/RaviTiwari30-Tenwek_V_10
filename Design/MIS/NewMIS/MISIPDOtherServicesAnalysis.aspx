<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MISIPDOtherServicesAnalysis.aspx.cs"
    Inherits="Design_MIS_MISIPDOtherServicesAnalysis" %>
            ...
            <table cellpadding="0" cellspacing="0" style="width: 100%; height: 100%">
                ...
                <tr>
                    <td style="width: 50%; text-align: center" valign="top">
                        <asp:Label ID="lblDocC" runat="server" ForeColor="Maroon" Font-Bold="true" Text="Doctor-wise" Visible="False"></asp:Label>
                    </td>
                    <td style="width: 50%; text-align: center" valign="top">
                        <asp:Label ID="lblItemwiseC" runat="server" ForeColor="Maroon" Text="Service-Wise" Font-Bold="true"
                ...
                <tr>
                    <td style="width: 50%; text-align: center;" valign="top">
                        <asp:Label ID="lblGroupC" runat="server" ForeColor="Maroon" Font-Bold="true" Text="Dept-wise / Group-wise"
                            Visible="False"></asp:Label>
                    </td>
                    <td style="width: 50%; text-align: center;" valign="top">
                        <asp:Label ID="lblPanelC" runat="server" ForeColor="Maroon" Font-Bold="true"  Text="Panel-wise" Visible="False"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td style="width: 50%;">
