<%@ Page Language="C#" MasterPageFile="~/DefaultHome.master" AutoEventWireup="true" CodeFile="NoteTypeMaster.aspx.cs" Inherits="Design_EMR_NoteTypeMaster" %>
    ...
    <script type="text/javascript">
        function bindHeader() {
            $.ajax({
                type: "POST",
                data: '{}',
                url: "Services/EMR.asmx/bindNoteTypeMaster",
                dataType: "json",
        ...
        function saveEMRHeader() {
            ...
            if ($.trim($("#txtHeader").val()) != "") {
                ...
                $.ajax({
                    ...
                    url: "Services/EMR.asmx/saveNoteTypeMaster",
                    dataType: "json",
                    contentType: "application/json;charset=UTF-8",
                    timeout: 120000,
                    async: false,
            ...
            if ($('#tb_grdEMR tr').length > 0) {
                ...
                if (EMR.length > "0") {
                    $.ajax({
                        ...
                        url: "Services/EMR.asmx/saveNoteTypeTable",
                        dataType: "json",
                        contentType: "application/json;charset=UTF-8",
                        timeout: 120000,
                        async: false,
