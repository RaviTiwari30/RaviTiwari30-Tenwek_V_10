<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UploadOtImages.aspx.cs" Inherits="Design_EMR_UploadOtImages" %>
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="S.No.">
                         ...
                         <asp:TemplateField HeaderText="EntryBy">
                            <ItemTemplate>
                                <asp:Label ID="lblEntryBy" runat="server" Text='<%#Eval("USER") %>' ></asp:Label>
                            </ItemTemplate>
                            <ItemStyle CssClass="GridViewLabItemStyle" />
                            <HeaderStyle CssClass="GridViewHeaderStyle" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Images">
                            <ItemTemplate>
                              <%--  <asp:Image ID="Image1" ImageUrl='<%#Eval("imgUrl") %>' runat="server" Width="300px" />--%>
                                <asp:ImageButton ID="imbView" runat="server" CausesValidation="false" CommandName="AView"  ImageUrl="~/Images/view.GIF" CommandArgument='<%# Eval("imgUrl")  %>' />
                            </ItemTemplate>
                            <ItemStyle CssClass="GridViewLabItemStyle" />
                            <HeaderStyle CssClass="GridViewHeaderStyle" />
                        </asp:TemplateField>
