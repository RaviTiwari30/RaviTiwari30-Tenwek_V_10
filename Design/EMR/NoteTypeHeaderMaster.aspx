<%@ Page Language="C#" MasterPageFile="~/DefaultHome.master" AutoEventWireup="true" CodeFile="NoteTypeHeaderMaster.aspx.cs" Inherits="Design_EMR_NoteTypeHeaderMaster" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        function bindHeader() {
            $.ajax({
                type: "POST",
                data: '{}',
                url: "Services/EMR.asmx/bindNoteTypeHeader",
                dataType: "json",
        ...
        function saveEMRHeader() {
            ...
            if ($.trim($("#txtHeader").val()) != "") {
                ...
                $.ajax({
                    ...
                    url: "Services/EMR.asmx/saveNoteTypeHeader",
                    dataType: "json",
                    contentType: "application/json;charset=UTF-8",
                    timeout: 120000,
                    async: false,
            ...
            if ($('#tb_grdEMR tr').length > 0) {
                ...
                if (EMR.length > "0") {
                    $.ajax({
                        ...
                        url: "Services/EMR.asmx/saveNoteTypeHeaderTable",
                        dataType: "json",
                        contentType: "application/json;charset=UTF-8",
                        timeout: 120000,
                        async: false,
    ...
    <div id="Pbody_box_inventory">
        <div class="POuter_Box_Inventory" style="text-align: center;">
            <b> Note Type Header Master </b> <br /> 
