...
$.fn.bindDropDown = function (params) {
 ...
 if (params.dataAttr) {
            ...
            // elem.append($('<option />').val(params.valueField === undefined ? this.toString() : this[params.valueField]).text(params.textField === undefined ? this.toString() : this[params.textField]).attr('data', JSON.stringify(dataAttr)));
            elem.append($(new Option).val(params.valueField === undefined ? this.toString() : this[params.valueField]).text(params.textField === undefined ? this.toString() : this[params.textField]).attr('data', JSON.stringify(dataAttr)));
...
$(document).ajaxStart(function (event, jqxhr, settings) {
    ...
    var unBlocksURL = [
		...
		'DoctorDisplayScreen.aspx/bindDoctorData',
        'DoctorDisplayScreen.aspx/bindCurrentPatient',
        'DisplayExaminationToken.aspx/bindPendingToken',
        'DisplayExaminationToken.aspx/BindDisplayToken',
		'DiagnosticTokenDisplayScreen.aspx/bindCurrentPatients',
		'DiagnosticTokenDisplayScreen.aspx/bindPendingPatients'
    ];
    ...
    if (xhr.status == 401)
        modelAlert('Session Time Out !!!', function () { window.location.href = '/svn/default.aspx'; });
    if (!opts.isReturn)
        $modelUnBlockUI();
...
//for model popup
//<div id="myModal"  model-target="myBtn" class="modal fade">
//       <div class="modal-dialog">
//           <div class="modal-content">
//               <div class="modal-header">
//                   <button type="button" class="close btn ItDoseButton" data-dismiss="modal" aria-hidden="true">&times;</button>
...
var $modelBlockUI = function () {
    var loader = '<img id="imgCustomJSLoader" style="width:100px;height:100px" alt="loading...." src="/svn/Images/loader.gif">'
