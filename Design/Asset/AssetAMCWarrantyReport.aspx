<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AssetAMCWarrantyReport.aspx.cs" MasterPageFile="~/DefaultHome.master" Inherits="Design_Asset_AssetAMCWarrantyReport" %>
...
<asp:Content ID="ct1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    <script type="text/javascript">
        ...
        var Search = function () {
            ...
            serverCall('AssetAMCWarrantyReport.aspx/GetAssetAMCWarrantyReport', data, function (response) {
