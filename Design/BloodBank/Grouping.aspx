<%@ Page Language="C#" MasterPageFile="~/DefaultHome.master" AutoEventWireup="true"
    CodeFile="Grouping.aspx.cs" Inherits="Design_BloodBank_Grouping" %>
            ...
            <div class="row">
                ...
                <div class="col-md-22">
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <asp:TextBox ID="txtDonorID" runat="server" TabIndex="3" MaxLength="20"></asp:TextBox>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <asp:TemplateField HeaderText="Status" HeaderStyle-Width="40px" ItemStyle-CssClass="GridViewItemStyle"
                                ...
                                <ItemTemplate>
                                    <asp:ImageButton ID="imgResult" runat="server" ImageUrl="../../Images/view.gif" class="status"
                                        CommandName="AStatus" CommandArgument='<%#Container.DataItemIndex %>' CausesValidation="false" />
                                </ItemTemplate>
                            </asp:TemplateField>
                    ...
                    <div style="text-align: center;">
                        &nbsp;<asp:DataList ID="dtInvestigation" runat="server" RepeatDirection="Horizontal"
                            ...
                            <ItemTemplate>
                                ...
                                <asp:DropDownList ID="ddlInvestigation" runat="server" Width="50px" onchange="abc(this);">
                                    <asp:ListItem Text="--" Value="0" Selected="True"></asp:ListItem>
                                    <asp:ListItem Text="N" Value="1"></asp:ListItem>
                                    <asp:ListItem Text="P" Value="2"></asp:ListItem>
                                    <asp:ListItem Text="W" Value="3" ID="rhvalue" style="display: none;"></asp:ListItem>
                                </asp:DropDownList>
                                &nbsp;&nbsp;
                            </ItemTemplate>
