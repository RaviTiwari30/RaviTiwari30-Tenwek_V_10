<%@ Page Language="C#" MasterPageFile="~/DefaultHome.master" AutoEventWireup="true" CodeFile="BloodRejectReport.aspx.cs" Inherits="Design_BloodBank_BloodRejectReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
       <script type="text/javascript">
        ...
        $(document).ready(function () {
            $('#txtRejectdatefrom').change(function () {
                ChkDate();
            });
            $('#txtRejectdateTo').change(function () {
                ChkDate();
            });
        });
        function ChkDate() {
            $.ajax({
                ...
                data: '{DateFrom:"' + $('#txtRejectdatefrom').val() + '",DateTo:"' + $('#txtRejectdateTo').val() + '"}',
                type: "POST",
                async: true,
                dataType: "json",
                ...
                <div class="col-md-22">
                    <div class="row">
                       ...
                       <div class="col-md-3">
                        ...
                        <div class="col-md-5">
                            <asp:TextBox ID="txtRejectdatefrom" runat="server" ClientIDMode="Static"></asp:TextBox>
                            <cc1:CalendarExtender ID="caldatefrom" TargetControlID="txtRejectdatefrom" Format="dd-MMM-yyyy"
                        ...
                        <div class="col-md-5">
                            <asp:TextBox ID="txtRejectdateTo" runat="server" ClientIDMode="Static"></asp:TextBox>
                            <cc1:CalendarExtender ID="caldateTo" TargetControlID="txtRejectdateTo" Format="dd-MMM-yyyy"
                                Animated="true" runat="server">
                            </cc1:CalendarExtender>
                        </div>
                    </div>
