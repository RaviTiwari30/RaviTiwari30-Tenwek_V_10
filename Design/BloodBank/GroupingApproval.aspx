<%@ Page Language="C#" MasterPageFile="~/DefaultHome.master" AutoEventWireup="true"
    CodeFile="GroupingApproval.aspx.cs" Inherits="Design_Bloodbank_GroupingApproval" %>
            ...
            <div class="row">
                <div class="col-md-24">
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <asp:TextBox ID="txtDonorId" runat="server" MaxLength="20" TabIndex="3"></asp:TextBox>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-3">
