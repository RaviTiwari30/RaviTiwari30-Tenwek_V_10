<%@ Page Title="" Language="C#" MasterPageFile="~/DefaultHome.master" AutoEventWireup="true" CodeFile="Recovery_ExcelUpload.aspx.cs" Inherits="Design_Recovery_Recovery_ExcelUpload" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="Pbody_box_inventory">
        <div class="POuter_Box_Inventory" style="text-align: center;">
            <b>Upload Recovery Master Sheets </b>
            <br />
            ...
            <table style="width: 100%">
                <tr>
                    ...
                    <td style="text-align: right">
                        <asp:Label ID="lblNote" runat="server" CssClass="ItDoseLblError" Text="Note : Only Csv file accepted."></asp:Label>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="text-align: right" colspan="2">Important: Please Upload &amp; Save the csv sheet one by one</td>
                </tr>
            </table>
        </div>
    </div>
