<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DisplayLaboratoryToken.aspx.cs" Inherits="Design_Token_DisplayLaboratoryToken" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function LoadTokenList() {
            ...
            $.ajax({
                url: "DisplayLaboratoryToken.aspx/DisplayTokenList",
        ...
        <div>
         ...
         <script id="tb_PatientLabSearch" type="text/html">
                        <table  id="tbl_Doctors" class="tbPatient"  border="0">
                         ...
                         #>                       
                        <tr id="td_<#=objRow.DocID#>"<#if(j==0){#>class="SelectedDoctor"<#} else {#> class="Doctor" <#}#>>
                         <td  style="width:25%;text-align:left;"><#= objRow.Department.toProperCase()#></td>
                         <td style="width:25%;text-align:left;"><#=objRow.InvestigationName.toProperCase() #></td>
                         <td style="width:25%;text-align:left;"><#=objRow.PatientName.toProperCase()#></td>
                         <# if(j!=0){#>
