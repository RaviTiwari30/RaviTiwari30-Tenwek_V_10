...
public partial class Design_CPOE_PatientICDCodes : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            foreach (GridViewRow gr in grvDig.Rows)
            {
                ...
                string sql = " insert into cpoe_10cm_patient(icd_id,TransactionID,PatientID,UserID,IsActive,ICD_Code,Comment1,AddToPatientList) values(" + ((Label)gr.FindControl("lblCodeID")).Text.Trim() + ",'" + TID + "','" + ViewState["PID"].ToString() + "','" + ViewState["ID"].ToString() + "',1,'" + ((Label)gr.FindControl("lblICDCode")).Text + "','" + ((Label)gr.FindControl("lblComment1")).Text + "','"+addtopatientlist+"')";
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        if (txtDiagnosisCode.Text.ToString() != "")
        {
            ...
            if (listDiagnosis.Contains(Diagnosis))
            {
                ...
                string str = "SELECT ID,ICD10_3_Code 'Sub Section',ICD10_3_Code_Desc 'Sub Section Desc.',ICD10_Code 'ICD Code',WHO_Full_Desc 'ICD Desc.' FROM icd_10_new WHERE ID >0 and Isactive=1 AND ICD10_Code='" + Diagnosis + "'  ";
    ...
    private void BindPatient(string TID)
    {
        ...
        sb.Append(" ICD10_3_Code , ICD10_3_Code_Desc ,ICD10_Code , WHO_Full_Desc ,icdp.icd_id,icdp.ID ,icdp.Comment1,IF(icdp.AddToPatientList='1','Yes','No')AddToPatientList ");
        ...
        sb.Append(" AND icd.Isactive=1 AND icdp.PatientID='" + ViewState["PID"].ToString() + "' ");
