<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PastHistory_Medication.aspx.cs" Inherits="Design_CPOE_PastHistory_Medication" %>
                ...
                <table style="width: 100%">
                    <tr style="display:none">
                     ...
                     <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtMedications" runat="server" ClientIDMode="Static" TextMode="MultiLine" Width="480px" Height="80px" MaxLength="1000"></asp:TextBox>
