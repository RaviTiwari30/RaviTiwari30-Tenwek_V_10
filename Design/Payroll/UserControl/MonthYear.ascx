<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MonthYear.ascx.cs" Inherits="Design_Payroll_UserControl_MonthYear" %>
<div>
<asp:DropDownList ID="ddlDate" Visible="False" runat="server" Width="40px" CssClass="opdsearchbox6" >
...
<asp:DropDownList ID="ddlMonth" runat="server" Width="54px" CssClass="opdsearchbox6" >
<asp:ListItem Selected="True" >-</asp:ListItem>
...
<asp:DropDownList ID="ddlYear" runat="server" Width="60px" CssClass="opdsearchbox6" >
<asp:ListItem Selected="True" >-</asp:ListItem>
