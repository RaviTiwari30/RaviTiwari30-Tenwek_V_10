...
/// <summary>
/// Summary description for IssueBlood
/// </summary>
public class IssueBlood
{
    ...
    private string _HoldBy;
    private int _ServiceRequestID;
    // private string _ReasonOf;
    ...
    public IssueBlood(MySqlTransaction objTrans)
    {
    ...
    //public virtual string ReasonOf
    //{
    //    get
    //    {
    //        return _ReasonOf;
    ...
    public string Insert()
    {
        try
        {
            ...
            objSQL.Append("bb_issue_blood_insert");
            if (IsLocalConn)
            {
                this.objCon.Open();
            ...
            paramTnxID.ParameterName = "_IssueId";
            ...
            this.IssueBy = Util.GetString(IssueBy);
            ...
            // this.ReasonOf = Util.GetString(ReasonOf);
            //this.IsProcess = Util.GetInt(IsProcess);
            this.IsHold = Util.GetInt(IsHold);
            this.HoldDate = Util.GetDateTime(HoldDate);
            this.HoldBy = Util.GetString(HoldBy);
            this.ServiceRequestID = Util.GetInt(ServiceRequestID);
            ...
            cmd.Parameters.Add(new MySqlParameter("@_IssueBy", IssueBy));
            ...
            cmd.Parameters.Add(new MySqlParameter("@_IsReturn", IsReturn));
            cmd.Parameters.Add(new MySqlParameter("@_ItemID", ItemID));
            cmd.Parameters.Add(new MySqlParameter("@_LedgerTnxID", LedgerTnxID));
            // cmd.Parameters.Add(new MySqlParameter("@_ReasonOf", ReasonOf));
            //    cmd.Parameters.Add(new MySqlParameter("@_IsProcess", IsProcess));
            cmd.Parameters.Add(new MySqlParameter("@_IsHold", IsHold));
            cmd.Parameters.Add(new MySqlParameter("@_HoldDate", HoldDate));
            cmd.Parameters.Add(new MySqlParameter("@_HoldBy", HoldBy));
            cmd.Parameters.Add(new MySqlParameter("@_ServiceRequestID", ServiceRequestID));
