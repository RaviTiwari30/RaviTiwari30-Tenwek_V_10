...
/// <summary>
/// Summary description for Method_Master
/// </summary>
public class Method_Master
{
    ...
    public Method_Master()
    {
        objCon = Util.GetMySqlCon();
        this.IsLocalConn = true;
    }

    public Method_Master(MySqlTransaction objTrans)
    {
    ...
    public string Insert()
    {
        try
        {
            ...
            objSQL.Append("bb_Method_Master");
            if (IsLocalConn)
            {
                this.objCon.Open();
