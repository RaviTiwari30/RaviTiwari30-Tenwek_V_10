...
/// <summary>
/// Summary description for Set_Item_Master_Detail
/// </summary>
public class Set_Item_Details
{
    ...
    public Set_Item_Details()
    {
        objCon = Util.GetMySqlCon();
        this.IsLocalConn = true;

    }
    public Set_Item_Details(MySqlTransaction objTrans)
    {
    ...
    public string Insert()
    {
        try
        {
            ...
            objSQL.Append("Laundry_Set_ItemDetail");
            if (IsLocalConn)
            {
                this.objCon.Open();
