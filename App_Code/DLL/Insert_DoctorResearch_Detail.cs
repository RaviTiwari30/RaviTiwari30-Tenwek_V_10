...
/// </summary>
public class Insert_DoctorResearch_Detail
{
	public Insert_DoctorResearch_Detail()
	{
        objCon = Util.GetMySqlCon();
        this.IsLocalConn = true;
	}
    public Insert_DoctorResearch_Detail(MySqlTransaction objTrans)
    {
     ...
     public string Insert()
     {
         ...
         try
         {
             ...
             objSQL.Append("Doctor_Research_master_Detail");
