...
public sealed class MySqlHelperNEw
{
    #region private utility methods & constructors

		//Since this class provides only static methods, make the default constructor private to prevent 
		//instances from being created with "new MySqlHelperNEw()".
        private MySqlHelperNEw() { }
    ...
    #region ExecuteNonQuery
		...
		public static int ExecuteNonQuery(string connectionString, string spName, params object[] parameterValues)
		{
			...
			if ((parameterValues != null) && (parameterValues.Length > 0)) 
			{
				...
				MySqlParameter[] commandParameters = MySqlHelperNEwParameterCache.GetSpParameterSet(connectionString, spName);
...
{	
		...
		public static int ExecuteNonQuery(MySqlConnection connection, string spName, params object[] parameterValues)
		{
			...
			{
				//pull the parameters for this stored procedure from the parameter cache (or discover them & populate the cache)
				MySqlParameter[] commandParameters = MySqlHelperNEwParameterCache.GetSpParameterSet(connection.ConnectionString, spName);
		...
		public static int ExecuteNonQuery(MySqlTransaction transaction, string spName, params object[] parameterValues)
		{
			...
			if ((parameterValues != null) && (parameterValues.Length > 0)) 
			{
				...
				MySqlParameter[] commandParameters = MySqlHelperNEwParameterCache.GetSpParameterSet(transaction.Connection.ConnectionString, spName);
	...
	#region ExecuteReader
		...
		/// <summary>
		/// this enum is used to indicate weather the connection was provided by the caller, or created by MySqlHelperNEw, so that
		/// we can set the appropriate CommandBehavior when calling ExecuteReader()
		/// </summary>
		private enum MySqlConnectionOwnership	
		{
			/// <summary>Connection is owned and managed by MySqlHelperNEw</summary>
			Internal, 
		...
		/// <param name="commandText">the stored procedure name or PL/SQL command</param> 
		/// <param name="commandParameters">an array of MySqlParameters to be associated with the command or 'null' if no parameters are required</param>
		/// <param name="connectionOwnership">indicates whether the connection parameter was provided by the caller, or created by MySqlHelperNEw</param>
...
/// <summary>
/// MySqlHelperNEwParameterCache provides functions to leverage a static cache of procedure parameters, and the
/// ability to discover parameters for stored procedures at run-time.
/// </summary>
public sealed class MySqlHelperNEwParameterCache
{
    #region private methods, variables, and constructors

    //Since this class provides only static methods, make the default constructor private to prevent 
    //instances from being created with "new MySqlHelperNEwParameterCache()".
    private MySqlHelperNEwParameterCache() { }
