...
public class DoctorMaster
{
    ...
    public string _LastUpdatedBy;
    public int _IsDocShare;
    public int _IsEmergencyAvailable;
    public string _CreatedBy;
    public int _IsUnit;

    public string _DoctorListId;
    public string _UnitDoctorID;
    public DateTime _CreatedDateTime;
    public int _IsActive;
    public string _Position;
    
    public int _IsSlotWiseToken;
    public int _Cadreid;
    public int _TierID;
    ...
    public virtual string DoctorListId
    {
        get { return _DoctorListId; }
        set { _DoctorListId = value; }
    }
    public virtual string UnitDoctorID
    {
        get { return _UnitDoctorID; }
        set { _UnitDoctorID = value; }
    }
...
public virtual int IsUnit
{
    ...
    public virtual int IsEmergencyAvailable { get { return _IsEmergencyAvailable; } set { _IsEmergencyAvailable = value; } }
    ...
    public string InsertDoctorUnit()
    {
        try
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("Insert_Doctor_Unit");
            ...
            if (IsLocalConn)
            {
                ...
                this.DoctorListId = Util.GetString(DoctorListId);
                this.UnitDoctorID = Util.GetString(UnitDoctorID);
                this.CreatedBy = Util.GetString(CreatedBy);
                this.CreatedDateTime = Util.GetDateTime(CreatedDateTime);
                this.IsActive = Util.GetInt(IsActive);
                this.Position = Util.GetString(Position);
               

                cmd.Parameters.Add(new MySqlParameter("@vDoctorListId", DoctorListId));
                cmd.Parameters.Add(new MySqlParameter("@vUnitDoctorID", UnitDoctorID));
                cmd.Parameters.Add(new MySqlParameter("@vCreatedBy", CreatedBy));
                cmd.Parameters.Add(new MySqlParameter("@vCreatedDateTime", CreatedDateTime));
                cmd.Parameters.Add(new MySqlParameter("@vIsActive", IsActive));
                cmd.Parameters.Add(new MySqlParameter("@vPosition", Position));
    ...
    public string Insert()
    {
        try
        {
           ...
           // this.HospCode = AllGlobalFunction.HospCode;
            ...
            this.IsDocShare = Util.GetInt(IsDocShare);
            this.IsEmergencyAvailable = Util.GetInt(IsEmergencyAvailable);
            this.CreatedBy = Util.GetString(CreatedBy);
            this.IsUnit = Util.GetInt(IsUnit);
            this.IsSlotWiseToken = Util.GetInt(IsSlotWiseToken);
            ...
            cmd.Parameters.Add(new MySqlParameter("@LastUpdatedBy", LastUpdatedBy));
            cmd.Parameters.Add(new MySqlParameter("@vIsDocShare", IsDocShare));
            cmd.Parameters.Add(new MySqlParameter("@vIsEmergencyAvailable", IsEmergencyAvailable));
            cmd.Parameters.Add(new MySqlParameter("@vFlagType", 0));
            cmd.Parameters.Add(new MySqlParameter("@CreatedBy", CreatedBy));
            cmd.Parameters.Add(new MySqlParameter("@vIsUnit", IsUnit));//
            cmd.Parameters.Add(new MySqlParameter("@vIsSlotWiseToken", IsSlotWiseToken));//
            cmd.Parameters.Add(new MySqlParameter("@Cadreid", Cadreid));//
            cmd.Parameters.Add(new MySqlParameter("@TierID", TierID));//
            cmd.Parameters.Add(paramTnxID);
    ...
    public int Update()
    {
        try
        {
            ...
            objSQL.Append("Gender = ?, DocDateTime=? DocDateTime=?,DocGroupId=?,DocDepartmentID=?,Cadreid=?,TierID=? WHERE DoctorID = ?");
    ...
    private void SetProperties(DataTable dtTemp)
    {
        ...
        this.DocGroupId = Util.GetString(dtTemp.Rows[0][AllTables.DoctorMaster.DocGroupId]);
        this.DocDepartmentID = Util.GetString(dtTemp.Rows[0][AllTables.DoctorMaster.DocDepartmentID]);
