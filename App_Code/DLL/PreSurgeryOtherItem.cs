...
/// <summary>
/// Summary description for PreSurgeryOtherItem
/// </summary>
public class PreSurgeryOtherItem
{
    public PreSurgeryOtherItem()
    {
        objCon = Util.GetMySqlCon();
        this.IsLocalConn = true;
    }

    public PreSurgeryOtherItem(MySqlTransaction objTrans)
    {
    ...
    public string Insert()
    {
        try
        {
            ...
            objSQL.Append("Insert_PreSurgeryOtherItem");
            if (IsLocalConn)
            {
                this.objCon.Open();
            ...
            cmd.Parameters.Add(new MySqlParameter("@_Rate", Util.GetDecimal(Rate)));
