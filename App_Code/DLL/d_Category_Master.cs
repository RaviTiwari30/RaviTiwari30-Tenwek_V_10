...
public class d_Category_Master
{
    ...
    private string _CategoryIDMain;
    ...
    public d_Category_Master(MySqlTransaction objTrans)
    {
    ...
    public virtual string CategoryIDMain
    {
        get
        {
            return _CategoryIDMain;
        }
        set
        {
            _CategoryIDMain = value;
        }
    }
    ...
    public string Insert()
    {
        try
        {
            ...
            objSQL.Append("Insert_d_CategoryMaster");
            if (IsLocalConn)
            {
                this.objCon.Open();
            ...
            this.CategoryIDMain = Util.GetString(CategoryIDMain);
            ...
            cmd.Parameters.Add(new MySqlParameter("@CategoryIDMain", CategoryIDMain));
    ...
    public int Update()
    {
        try
        {
            int RowAffected;
            StringBuilder objSQL = new StringBuilder();
            objSQL.Append("UPDATE d_f_categorymaster SET Hospital_ID=?,Name = ?, Description = ?, TableReference = ?,IsEffectiveEventory=?,CategoryIDMain=?,TypeDummy=? WHERE CategoryID = ? ");
            ...
            RowAffected = MySqlHelper.ExecuteNonQuery(objTrans, CommandType.Text, objSQL.ToString(),
                ...
                new MySqlParameter("@TypeDummy", TypeDummy),
                new MySqlParameter("@CategoryIDMain", CategoryIDMain));
    ...
    public int Delete()
    {
        try
        {
            int iRetValue;
            StringBuilder objSQL = new StringBuilder();
            objSQL.Append("DELETE FROM d_f_categorymaster WHERE CategoryID = ?");
    ...
    public bool Load()
    {
        ...
        try
        {
            ...
            string sSQL = "SELECT * FROM d_f_categorymaster WHERE CategoryID = ?";
