...
/// <summary>  
/// Summary description for f_reciept  
/// Generated using MySqlManager  
/// ========================================================================================== 
/// Author:              PANKAJRAWAT 
/// Create date:	4/25/2013 6:05:07 PM 
/// Description:	This class is intended for inserting, updating, deleting values for f_reciept table 
/// ========================================================================================== 
/// </summary>  

public class MortuaryReceipt
{
    public MortuaryReceipt()
    {
        objCon = Util.GetMySqlCon();
        this.IsLocalConn = true;
    }
    public MortuaryReceipt(MySqlTransaction objTrans)
    {
    ...
    public virtual string Transaction_ID { get { return _Transaction_ID; } set { _Transaction_ID = value; } }
    ...
    public virtual float Discount { get { return _Discount; } set { _Discount = value; } }
    ...
    public virtual int HospCentreID { get { return _HospCentreID; } set { _HospCentreID = value; } }
    ...
    public string Insert()
    {
        ...
        try
        {
            ...
            objSQL.Append("insert_mortuary_receipt");
            if (IsLocalConn)
            {
                this.objCon.Open();
            ...
            cmd.Parameters.Add(new MySqlParameter("@vTransaction_ID", Util.GetString(Transaction_ID)));
            cmd.Parameters.Add(new MySqlParameter("@vPanel_ID", Util.GetInt(Panel_ID)));
            ...
            cmd.Parameters.Add(new MySqlParameter("@vDiscount", Util.GetFloat(Discount)));
