...
/// <summary>
/// Summary description for ExpenceAccntReceipt
/// </summary>
public class ExpenceAccntReceipt
{
    ...
    public ExpenceAccntReceipt(MySqlTransaction objTrans)
    {
    ...
    public string Insert()
    {
        try
        {
            ...
            objSQL.Append("Insert_AcctExpenceReceipt");
            if (IsLocalConn)
            {
                this.objCon.Open();
