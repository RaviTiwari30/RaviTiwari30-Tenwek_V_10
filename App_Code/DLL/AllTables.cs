...
public class AllTables
{
    ...
    public struct Patient_Medical_History
    {
        ...
        public const string PatientID = "PatientID";
        public const string DoctorID = "DoctorID";
        public const string DoctorID1 = "DoctorID1";
        public const string Hospital_ID = "Hospital_ID";
        public const string Time = "Time";
        ...
        public const string Ownership = "Ownership";
        public const string GroupID = "GroupID";
        public const string ReferedTransactionID = "ReferedTransactionID";
    ...
    public struct Patient_Due_Test_Report
    {
        ...
        public const string PatientID = "PatientID";
        public const string PatientID_Status = "PatientID_Status";
        public const string TransactionID_Location = "TransactionID_Location";
        public const string TransactionID_HospCode = "TransactionID_HospCode";
        public const string TransactionID_ID = "TransactionID_ID";
        public const string DoctorID = "DoctorID";
    ...
    public struct Patient_IPD_Profile
    {
        ...
        public const string IPDCaseTypeID_Bill = "IPDCaseTypeID_Bill";
    ...
    #endregion All tables and its field name
    ...
    public struct Patient_Master
    {
        ...
        public const string PFirstName = "PFirstName";
        public const string PLastName = "PlastName";
        public const string House_No = "House_No";
        public const string Street_Name = "Street_Name";
        public const string Locality = "Locality";
        public const string City = "City";
    ...
    public struct DoctorMaster
    {
        ...
        public const string City = "City";
        public const string Gender = "Gender";
        public const string DocGroupId = "DocGroupId";
        public const string DocDepartmentID = "DocDepartmentID";
    }
    ...
    public struct Doctor_hospital
    {
        ...
        public const string DurationforNewPatient = "DurationforNewPatient";
        public const string DurationforOldPatient = "DurationforOldPatient";
        public const string DocFloor = "DocFloor";
    }
    ...
    public struct Surgery_Calculator
    {
        ...
        public const string SurgeryGroupID = "SurgeryGroupID";
    ...
    public struct Panel_Process_Master
    {
        public const string ProcessID = "ProcessID";
        public const string PanelID = "PanelID";
        public const string IsActive = "IsActive";
    ...
    public struct Recovery_Action
    {
        public const string ProcessID = "ProcessID";
        public const string QueryID = "QueryID";
        public const string TPAInvNo = "TPAInvNo";
        public const string IPNo = "IPNo";
        public const string BillNo = "BillNo";
        public const string TargetDate = "TargetDate";
        public const string ExpectedDate = "ExpectedDate";
        public const string CreatedBy = "CreatedBy";
        public const string UpdatedBy = "UpdatedBy";
        public const string IsTPAQuery = "IsTPAQuery";
        public const string UserRemark = "UserRemark";
        public const string RAID = "RAID";
        public const string Type = "Type";
        public const string IsClose = "IsClose";
    }

    public struct Payment_Confirmation
    {
        public const string TPAInvNo = "TPAInvNo";
        public const string IPNo = "IPNo";
        public const string BillNo = "BillNo";
        public const string ChequeDate = "ChequeDate";
        public const string ChequeReceiveDate = "ChequeReceiveDate";
        public const string ChequeAmount = "ChequeAmount";
        public const string CreatedBy = "CreatedBy";
        public const string UpdatedBy = "UpdatedBy";
        public const string PaymentRemark = "PaymentRemark";
        public const string Type = "Type";
    }
