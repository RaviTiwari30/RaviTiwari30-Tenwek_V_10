...
var WYSIWYG = {
	...
	Settings: function() {
		...
		// Images Directory
		this.ImagesDir = "../../IEdit/images/";
		
		// Popups Directory
		this.PopupsDir = "../../IEdit/popups/";
		
		// CSS Directory File
		this.CSSFile = "../../IEdit/styles/wysiwyg.css";		
		...
		this.DefaultStyle = "font-family: Courier New; font-size: 12px; background-color: #FFFFFF";
		
		// Stylesheet if editor is disabled
		this.DisabledStyle = "font-family: Courier New; font-size: 12px; background-color: #EEEEEE";
		...
		this.NoValidBrowseRCMSsage = "RCMS Rich TextBox does not support your browser.";
		...
		this.DropDowns['headings'] = {	
			id: "headings",
			command: "FormatBlock",
			label: "<{value} style=\"margin:0px;text-decoration:none;font-family:Verdana, Arial, sans-serif\">{value}</{value}>",
			width: "74px",
			elements: new Array(
				"H1", 
				"H2", 
	...
	_display: function(n, settings) {
		...
		if(!WYSIWYG_Core.isBrowserCompatible()) {
			if(this.config[n].NoValidBrowseRCMSsage != "") { this.config[n].NoValidBrowseRCMSsage; }
			return;
		}
